#ifndef STORM_PROPERTIES_PRCTL_CUMULATIVEREWARD_H_
#define STORM_PROPERTIES_PRCTL_CUMULATIVEREWARD_H_
		...
		namespace prctl {
			...
			public:
				...
				virtual std::shared_ptr<AbstractRewardPathFormula<T>> clone() const override {
					auto result = std::make_shared<CumulativeReward<T>>(this->getBound());
					return result;
				}
...
#endif /* STORM_PROPERTIES_PRCTL_CUMULATIVEREWARD_H_ */
