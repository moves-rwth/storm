#ifndef STORM_PROPERTIES_PRCTL_PROBABILISTICBOUNDOPERATOR_H_
#define STORM_PROPERTIES_PRCTL_PROBABILISTICBOUNDOPERATOR_H_
...
#endif /* STORM_PROPERTIES_PRCTL_PROBABILISTICBOUNDOPERATOR_H_ */
