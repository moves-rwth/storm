#ifndef STORM_PROPERTIES_PRCTL_BOUNDEDUNTIL_H_
#define STORM_PROPERTIES_PRCTL_BOUNDEDUNTIL_H_
		...
		namespace prctl {
			...
			class IBoundedUntilModelChecker {
				public:
					 ...
					 */
					virtual std::vector<T> checkBoundedUntil(BoundedUntil<T> const & obj, bool qualitative) const = 0;
			};
...
#endif /* STORM_PROPERTIES_PRCTL_BOUNDEDUNTIL_H_ */
