#ifndef STORM_PROPERTIES_PRCTL_STEADYSTATEREWARD_H_
#define STORM_PROPERTIES_PRCTL_STEADYSTATEREWARD_H_
		...
		namespace prctl {
			...
			class ISteadyStateRewardModelChecker {
				public:
					 ...
					 */
					virtual std::vector<T> checkSteadyStateReward(SteadyStateReward<T> const & obj, bool qualitative) const = 0;
			};
...
#endif /* STORM_PROPERTIES_PRCTL_STEADYSTATEREWARD_H_ */
