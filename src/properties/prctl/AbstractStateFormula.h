#ifndef STORM_PROPERTIES_PRCTL_ABSTRACTSTATEFORMULA_H_
#define STORM_PROPERTIES_PRCTL_ABSTRACTSTATEFORMULA_H_
...
#endif /* STORM_PROPERTIES_PRCTL_ABSTRACTSTATEFORMULA_H_ */
