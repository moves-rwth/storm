...
#include "storm-pars/modelchecker/region/detail/RegionSplitEstimateKind.h"
...
class RegionModelChecker {
   public:
     ...
     */
    std::optional<detail::RegionSplitEstimateKind> getSpecifiedRegionSplitEstimateKind() const;
