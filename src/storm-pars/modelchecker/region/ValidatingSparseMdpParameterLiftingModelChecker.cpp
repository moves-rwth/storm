...
namespace storm {
    namespace modelchecker {
        ...
        template <typename SparseModelType, typename ImpreciseType, typename PreciseType>
        void ValidatingSparseMdpParameterLiftingModelChecker<SparseModelType, ImpreciseType, PreciseType>::specify(Environment const& env, std::shared_ptr<storm::models::ModelBase> parametricModel, CheckTask<storm::logic::Formula, typename SparseModelType::ValueType> const& checkTask, [[maybe_unused]] bool generateRegionSplitEstimates, [[maybe_unused]] bool allowModelSimplifications) {
