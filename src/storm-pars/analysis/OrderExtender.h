...
namespace storm {
    namespace analysis {
        ...
        private:
            ...
            std::pair<uint_fast64_t, uint_fast64_t> extendStateToHandle(std::shared_ptr<Order> order, uint_fast64_t currentState, std::vector<uint_fast64_t> const& successors, bool allowMerge, bool onlyBackwards);
            std::pair<uint_fast64_t, uint_fast64_t> extendNormal(std::shared_ptr<Order> order, uint_fast64_t currentState, uint_fast64_t currentSCC, std::vector<uint_fast64_t> const& successors, bool allowMerge, bool onlyBackwards);
            ...
            std::pair<uint_fast64_t, uint_fast64_t> extendByMinMax(std::shared_ptr<Order> order, uint_fast64_t currentState, std::vector<uint_fast64_t> const& successors, bool allowMerge);
