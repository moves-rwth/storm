...
std::string MonotonicityResult<VariableType>::toString() const {
    ...
    result = "#Incr: " + std::to_string(countIncr) + " #Decr: " + std::to_string(countDecr) + " #Const: " + std::to_string(countConst) +
             " #NotMon: " + std::to_string(countNotMon) + " #Unknown: " + std::to_string(countUnknown) + "\n" + result;
    return result;
}
