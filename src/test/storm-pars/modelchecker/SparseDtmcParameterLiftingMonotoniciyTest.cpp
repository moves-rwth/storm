...
//        std::vector<std::shared_ptr<const storm::logic::Formula>> formulas =
//        storm::api::extractFormulasFromProperties(storm::api::parsePropertiesForPrismProgram(formulaAsString, program));
//        std::shared_ptr<storm::models::sparse::Dtmc<storm::RationalFunction>> model = storm::api::buildSparseModel<storm::RationalFunction>(program,
//        formulas)->as<storm::models::sparse::Dtmc<storm::RationalFunction>>();
//
//        // Simplify model
//        auto simplifier = storm::transformer::SparseParametricDtmcSimplifier<storm::models::sparse::Dtmc<storm::RationalFunction>>(*model);
//        ASSERT_TRUE(simplifier.simplify(*(formulas[0])));
...
//        bisimType)->as<storm::models::sparse::Dtmc<storm::RationalFunction>>();
//
//        // Model parameters
//        auto modelParameters = storm::models::sparse::getProbabilityParameters(*model);
//        auto rewParameters = storm::models::sparse::getRewardParameters(*model);
...
//        auto monRes =  monHelper->checkMonotonicityInBuild(boost::none);
//        auto order = monRes.begin()->first;
//        ASSERT_EQ(order->getNumberOfAddedStates(), model->getTransitionMatrix().getColumnCount());
//        ASSERT_TRUE(order->getDoneBuilding());
//        auto localMonRes = std::make_shared<storm::analysis::LocalMonotonicityResult<storm::RationalFunctionVariable>>(monRes.begin()->second.first,
//        order->getNumberOfStates());
//
//        // Modelcheckers
//        auto regionCheckerMon = storm::api::initializeParameterLiftingRegionModelChecker<storm::RationalFunction, ValueType>(this->env(), model,
//        storm::api::createTask<storm::RationalFunction>(formulas[0], true), false, false,  false, storm::api::MonotonicitySetting(true)); auto regionChecker =
//        storm::api::initializeParameterLiftingRegionModelChecker<storm::RationalFunction, ValueType>(this->env(), model,
//        storm::api::createTask<storm::RationalFunction>(formulas[0], true), false, false, false);
//
//        //start testing
//        auto allSatRegion=storm::api::parseRegion<storm::RationalFunction>("0.7<=pL<=0.9,0.75<=pK<=0.95", modelParameters);
//        auto expectedResult = regionChecker->analyzeRegion(this->env(), allSatRegion, storm::modelchecker::RegionResultHypothesis::Unknown,
//        storm::modelchecker::RegionResult::Unknown, true); EXPECT_EQ(expectedResult, regionCheckerMon->analyzeRegion(this->env(), allSatRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown, storm::modelchecker::RegionResult::Unknown, true, localMonRes));
//
//        auto exBothRegion=storm::api::parseRegion<storm::RationalFunction>("0.4<=pL<=0.65,0.75<=pK<=0.95", modelParameters);
//        expectedResult = regionChecker->analyzeRegion(this->env(), exBothRegion, storm::modelchecker::RegionResultHypothesis::Unknown,
//        storm::modelchecker::RegionResult::Unknown, true); EXPECT_EQ(expectedResult, regionCheckerMon->analyzeRegion(this->env(), exBothRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true, localMonRes));
//
//        auto allVioRegion=storm::api::parseRegion<storm::RationalFunction>("0.1<=pL<=0.73,0.2<=pK<=0.715", modelParameters);
//        expectedResult = regionChecker->analyzeRegion(this->env(), allVioRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true); EXPECT_EQ(expectedResult,
//        regionCheckerMon->analyzeRegion(this->env(), allVioRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true, localMonRes));
//    }
//
//    TYPED_TEST(SparseDtmcParameterLiftingMonotonicityTest, Brp_Prob_Mon_GEQ) {
...
//
//        auto exBothRegion=storm::api::parseRegion<storm::RationalFunction>("0.4<=pL<=0.65,0.75<=pK<=0.95", modelParameters);
//        expectedResult = regionChecker->analyzeRegion(this->env(), exBothRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true); EXPECT_EQ(expectedResult,
//        regionCheckerMon->analyzeRegion(this->env(), exBothRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true, localMonRes));
//
//        auto allVioRegion=storm::api::parseRegion<storm::RationalFunction>("0.7<=pL<=0.9,0.75<=pK<=0.95", modelParameters);
//        expectedResult =regionChecker->analyzeRegion(this->env(), allVioRegion,
...
//        auto allVioRegion=storm::api::parseRegion<storm::RationalFunction>("0.7<=pL<=0.9,0.75<=pK<=0.95", modelParameters);
//        expectedResult =regionChecker->analyzeRegion(this->env(), allVioRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true);
//        EXPECT_EQ(expectedResult,regionCheckerMon->analyzeRegion(this->env(), allVioRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true, localMonRes));
//    }
//
//    TYPED_TEST(SparseDtmcParameterLiftingMonotonicityTest, Parametric_Die_Mon) {
...
//        auto allSatRegion = storm::api::parseRegion<storm::RationalFunction>("0.1<=p<=0.2,0.8<=q<=0.9", modelParameters);
//        auto monHelper = new storm::analysis::MonotonicityHelper<storm::RationalFunction, ValueType>(model, formulas, {});
//        auto order =  monHelper->checkMonotonicityInBuild(boost::none).begin()->first;
//        auto monRes = monHelper->createLocalMonotonicityResult(order, allSatRegion);
//        EXPECT_EQ(regionChecker->analyzeRegion(this->env(), allSatRegion, storm::modelchecker::RegionResultHypothesis::Unknown,
//        storm::modelchecker::RegionResult::Unknown, true), regionCheckerMon->analyzeRegion(this->env(), allSatRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown, storm::modelchecker::RegionResult::Unknown, true, monRes));
//
//        auto exBothRegion = storm::api::parseRegion<storm::RationalFunction>("0.1<=p<=0.9,0.1<=q<=0.9", modelParameters);
//        EXPECT_EQ(regionChecker->analyzeRegion(this->env(), exBothRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true), regionCheckerMon->analyzeRegion(this->env(),
//        exBothRegion, storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true, monRes));
//
//        auto allVioRegion = storm::api::parseRegion<storm::RationalFunction>("0.8<=p<=0.9,0.1<=q<=0.2", modelParameters);
//        EXPECT_EQ(regionChecker->analyzeRegion(this->env(), allVioRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true), regionCheckerMon->analyzeRegion(this->env(),
//        allVioRegion, storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true, monRes));
//    }
//
//    TYPED_TEST(SparseDtmcParameterLiftingMonotonicityTest, Simple1_Mon) {
//        typedef typename TestFixture::ValueType ValueType;
...
//        auto exBothRegion=storm::api::parseRegion<storm::RationalFunction>("0.1<=p<=0.9", modelParameters);
//        EXPECT_EQ(regionChecker->analyzeRegion(this->env(), exBothRegion, storm::modelchecker::RegionResultHypothesis::Unknown,
//        storm::modelchecker::RegionResult::Unknown, true), regionCheckerMon->analyzeRegion(this->env(), exBothRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true, monRes));
//
//        auto allVioRegion=storm::api::parseRegion<storm::RationalFunction>("0.05<=p<=0.1", modelParameters);
//        EXPECT_EQ(regionChecker->analyzeRegion(this->env(), allVioRegion, storm::modelchecker::RegionResultHypothesis::Unknown,
//        storm::modelchecker::RegionResult::Unknown, true), regionCheckerMon->analyzeRegion(this->env(), allVioRegion,
//        storm::modelchecker::RegionResultHypothesis::Unknown,storm::modelchecker::RegionResult::Unknown, true, monRes));
//    }
//
//    TYPED_TEST(SparseDtmcParameterLiftingMonotonicityTest, Casestudy1_Mon) {
...
//        storm::api::createTask<storm::RationalFunction>(formulas[0], true), false, false, false);
//
//        model->getTransitionMatrix().printAsMatlabMatrix(boost::none);
//
//        auto monHelper = new storm::analysis::MonotonicityHelper<storm::RationalFunction, ValueType>(model, formulas, {});
//        auto order =  monHelper->checkMonotonicityInBuild(boost::none).begin()->first;
//        ASSERT_TRUE(order->getDoneBuilding());
...
//        storm::modelchecker::RegionResultHypothesis::Unknown, storm::modelchecker::RegionResult::Unknown, true, monRes));
//    }
//>>>>>>> 3eab052f5b42c2b63a71397aa2b834953f7abe51
}  // namespace
#endif
