...
TEST(RewardOrderExtenderTest, smt_state_succ_compare) {
    ...
    // Extender
    auto extender = storm::analysis::RewardOrderExtenderDtmc<storm::RationalFunction, double>(model, formulas[0]);
    extender.setRegion(region);
    ...
    succs6.push_back(5);
    succs6.push_back(7);
    extender.extendByBackwardReasoning(order, 6, succs6, false);
    ...
    succs4.push_back(6);
    succs4.push_back(7);
    extender.extendByBackwardReasoning(order, 4, succs4, false);
    ...
    succs3.push_back(5);
    succs3.push_back(6);
    extender.extendByBackwardReasoning(order, 3, succs3, false);
    ...
    succs2.push_back(3);
    succs2.push_back(4);
    extender.extendByBackwardReasoning(order, 2, succs2, false);
    ...
    succs1.push_back(3);
    succs1.push_back(4);
    extender.extendByBackwardReasoning(order, 1, succs1, false);
    ...
    succs0.push_back(1);
    succs0.push_back(2);
    auto res = extender.extendByBackwardReasoning(order, 0, succs0, false);
