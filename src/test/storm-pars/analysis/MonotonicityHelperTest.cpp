...
//     for (auto var : varsP) {
//         typename storm::storage::ParameterRegion<storm::RationalFunction>::CoefficientType lb = storm::utility::convertNumber<typename
//         storm::storage::ParameterRegion<storm::RationalFunction>::CoefficientType>(0 + 0.000001); typename
//         storm::storage::ParameterRegion<storm::RationalFunction>::CoefficientType ub = storm::utility::convertNumber<typename
//         storm::storage::ParameterRegion<storm::RationalFunction>::CoefficientType>(1 - 0.000001); lowerBoundaries2.emplace(std::make_pair(var, lb));
...
//     formulas)->as<storm::models::sparse::Dtmc<storm::RationalFunction>>(); auto simplifier =
//     storm::transformer::SparseParametricDtmcSimplifier<storm::models::sparse::Dtmc<storm::RationalFunction>>(*model);
...
//     bisimType)->as<storm::models::sparse::Dtmc<storm::RationalFunction>>(); ASSERT_EQ(99ul, model->getNumberOfStates()); ASSERT_EQ(195ul,
...
//
//     // Start testing
//     storm::analysis::MonotonicityHelper<storm::RationalFunction, double> MonotonicityHelper = storm::analysis::MonotonicityHelper<storm::RationalFunction,
//     double>(model, formulas, regions, true);
//     // Check if correct result size
//     auto result = MonotonicityHelper.checkMonotonicityInBuild(boost::none, false, false);
...
//     // Start testing
//     storm::analysis::MonotonicityHelper<storm::RationalFunction, double> MonotonicityHelper = storm::analysis::MonotonicityHelper<storm::RationalFunction,
//     double>(model, formulas, regions, true, 50);
//     // Check if correct result size
//     auto result = MonotonicityHelper.checkMonotonicityInBuild(boost::none, false, false);
//     EXPECT_EQ(1ul, result.size());
//
