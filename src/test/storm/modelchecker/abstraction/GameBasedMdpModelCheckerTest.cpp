...
TEST(GameBasedMdpModelCheckerTest, DISABLED_Dice_Sylvan) {
    ...
    auto mdpModelchecker = std::make_shared<storm::modelchecker::GameBasedMdpModelChecker<storm::dd::DdType::Sylvan, storm::models::symbolic::Mdp<storm::dd::DdType::Sylvan>>>(program);
