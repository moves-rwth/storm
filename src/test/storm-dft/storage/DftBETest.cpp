...
TEST(DftBETest, FailureProbability) {
    ...
    EXPECT_DOUBLE_EQ(0.4, be.getUnreliability(0.4));
    EXPECT_DOUBLE_EQ(0.4, be.getUnreliability(0.5));
    EXPECT_DOUBLE_EQ(0.4, be.getUnreliability(1));
    EXPECT_DOUBLE_EQ(0.4, be.getUnreliability(5));
}
...
TEST(DftBETest, FailureExponential) {
    ...
    EXPECT_DOUBLE_EQ(0.7768698399, be.getUnreliability(0.5));
    EXPECT_DOUBLE_EQ(0.9502129316, be.getUnreliability(1));
    EXPECT_DOUBLE_EQ(0.9975212478, be.getUnreliability(2));
}
...
TEST(DftBETest, FailureErlang) {
    ...
    EXPECT_EQ(0, be2.getUnreliability(0));
    EXPECT_DOUBLE_EQ(0.0656424544, be2.getUnreliability(0.5));
    EXPECT_DOUBLE_EQ(0.3527681112, be2.getUnreliability(1));
    EXPECT_DOUBLE_EQ(0.6577040442, be2.getUnreliability(1.5));
    EXPECT_DOUBLE_EQ(0.8487961172, be2.getUnreliability(2));
    EXPECT_DOUBLE_EQ(0.9997886215, be2.getUnreliability(5));
}
...
TEST(DftBETest, FailureWeibullExponential) {
    ...
    for (double t = 0; t <= 5.0; t += 0.25) {
        EXPECT_DOUBLE_EQ(boost::math::cdf(dist, t), be.getUnreliability(t));
    }
    ...
    EXPECT_EQ(0, be2.getUnreliability(0));
    EXPECT_DOUBLE_EQ(0.0605869372, be2.getUnreliability(0.5));
    EXPECT_DOUBLE_EQ(0.2211992169, be2.getUnreliability(1));
    EXPECT_DOUBLE_EQ(0.6321205588, be2.getUnreliability(2));
    EXPECT_DOUBLE_EQ(0.9980695486, be2.getUnreliability(5));

    // Compare with boost results
    boost::math::weibull_distribution<double> dist2(2, 2);
    for (double t = 0; t <= 5.0; t += 0.25) {
        EXPECT_DOUBLE_EQ(boost::math::cdf(dist2, t), be2.getUnreliability(t));
    }
    ...
    EXPECT_DOUBLE_EQ(0.4369287910, be3.getUnreliability(0.5));
    EXPECT_DOUBLE_EQ(0.5313308906, be3.getUnreliability(1));
    EXPECT_DOUBLE_EQ(0.6321205588, be3.getUnreliability(2));
    EXPECT_DOUBLE_EQ(0.7637110612, be3.getUnreliability(5));

    // Compare with boost results
    boost::math::weibull_distribution<double> dist3(0.4, 2);
    for (double t = 0; t <= 5.0; t += 0.25) {
        EXPECT_DOUBLE_EQ(boost::math::cdf(dist3, t), be3.getUnreliability(t));
    }
}
...
TEST(DftBETest, FailureLogNormal) {
    ...
    EXPECT_EQ(0, be.getUnreliability(0));
    EXPECT_DOUBLE_EQ(0.0828285190, be.getUnreliability(0.5));
    EXPECT_DOUBLE_EQ(0.5, be.getUnreliability(1));
    EXPECT_DOUBLE_EQ(0.9171714810, be.getUnreliability(2));
    EXPECT_DOUBLE_EQ(0.9993565290, be.getUnreliability(5));
    ...
    EXPECT_EQ(0, be2.getUnreliability(0));
    EXPECT_DOUBLE_EQ(6.32491e-12, be2.getUnreliability(0.5));
    EXPECT_DOUBLE_EQ(3.167124183e-5, be2.getUnreliability(1));
    EXPECT_DOUBLE_EQ(0.1098340249, be2.getUnreliability(2));
    EXPECT_DOUBLE_EQ(0.9926105382, be2.getUnreliability(5));
}
