                ...
                if (iteration < 1) {
                    ...
                    switch (usedHeuristic) {
                        case storm::builder::ApproximationHeuristic::DEPTH:
                            explorationQueue = storm::storage::BucketPriorityQueue<ExplorationHeuristic>(300, 0, 0.9,
                                                                                                         false);//Shahid:use 300 as number of elements in BDMP later change it to actual numerdft.nrElements()+1, 0, 0.9, false);
                            break;
                        case storm::builder::ApproximationHeuristic::PROBABILITY:
                            explorationQueue = storm::storage::BucketPriorityQueue<ExplorationHeuristic>(200, 0, 0.9,
                                                                                                         true);
                            break;
...
//                    // Initialize heuristic values for inital state
                    ...
                    switch (usedHeuristic) {
                        case storm::builder::ApproximationHeuristic::DEPTH:
                            heuristic = std::make_shared<storm::builder::DFTExplorationHeuristicDepth<ValueType>>(
                                    initialStateIndex);
                            break;
                        case storm::builder::ApproximationHeuristic::PROBABILITY:
                            heuristic = std::make_shared<storm::builder::DFTExplorationHeuristicProbability<ValueType>>(
                                    initialStateIndex);
                            break;
                        case storm::builder::ApproximationHeuristic::BOUNDDIFFERENCE:
                            heuristic = std::make_shared<storm::builder::DFTExplorationHeuristicBoundDifference<ValueType>>(
                                    initialStateIndex);
                            break;
                        default:
                            STORM_LOG_THROW(false, storm::exceptions::IllegalArgumentException, "Heuristic not known.");
            ...
            template<typename ValueType, typename StateType>
            void storm::figaro::builder::ExplicitFigaroModelBuilder<ValueType, StateType>::initializeNextIteration() {
