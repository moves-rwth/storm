...
/*!
         ...
         */
            ...
            public:
                 ...
                 */
                figaro_results check(storm::figaro::FigaroProgram & origFigaro, property_vector const& properties,
            ...
            private:
                 ...
                 */
                figaro_results checkFigaro(storm::figaro::FigaroProgram & origFigaro, property_vector const& properties,
                                     double approximationError = 0.0, storm::builder::ApproximationHeuristic approximationHeuristic = storm::builder::ApproximationHeuristic::DEPTH,
                                     bool eliminateChains = false);
