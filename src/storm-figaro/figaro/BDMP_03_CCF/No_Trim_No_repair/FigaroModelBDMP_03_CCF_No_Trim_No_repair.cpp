#include <iostream>
#include "FigaroModelBDMP_03_CCF_No_Trim_No_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::init()
{
	...
	FIRE_xx23_OF_CCF_fail_B_INS_2 = false;
	FIRE_xx23_OF_CCF_fail_B_INS_3 = false;
	FIRE_xx23_OF_CCF_fail_C_INS_4 = false;
	FIRE_xx23_OF_CCF_fail_C_INS_5 = false;
...
void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::fireOccurrence(int numFire)
{
	...
	if (numFire == 2)
	{
		FIRE_xx23_OF_CCF_fail_B_INS_2 = true;
	}
	...
	if (numFire == 4)
	{
		FIRE_xx23_OF_CCF_fail_C_INS_4 = true;
	}

	if (numFire == 5)
	{
		FIRE_xx23_OF_CCF_fail_C_INS_5 = true;
	}
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failI_OF_CCF_fail_B] == false) && boolState[to_be_fired_OF_CCF_fail_B]) 
	{
		...
		if (FIRE_xx23_OF_CCF_fail_B_INS_2) 
		{
	...
	if ((boolState[failI_OF_CCF_fail_C] == false) && boolState[to_be_fired_OF_CCF_fail_C]) 
	{
		...
		if (FIRE_xx23_OF_CCF_fail_C_INS_4) 
		{
	...
	if ((boolState[failI_OF_CCF_fail_C] == false) && boolState[to_be_fired_OF_CCF_fail_C]) 
	{
		...
		if (FIRE_xx23_OF_CCF_fail_C_INS_5) 
		{
			boolState[already_standby_OF_CCF_fail_C]  =  false;
			boolState[already_required_OF_CCF_fail_C]  =  false;
			FIRE_xx23_OF_CCF_fail_C_INS_5 = false;
	...
	if ((boolState[failF_OF_Indep_fail_A] == false) && boolState[required_OF_Indep_fail_A]) 
	{
	...
	if ((boolState[failF_OF_Indep_fail_B] == false) && boolState[required_OF_Indep_fail_B]) 
	{
	...
	if ((boolState[failF_OF_Indep_fail_C] == false) && boolState[required_OF_Indep_fail_C]) 
	{
	...
	if ((boolState[failF_OF_Shock] == false) && boolState[required_OF_Shock]) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::showFireableOccurrences()
{
	...
	if ((boolState[failI_OF_CCF_fail_B] == false) && boolState[to_be_fired_OF_CCF_fail_B])
	{
		cout << "2 :  INS_SUB_COUNT (2) |FAULT | failI  LABEL \"instantaneous failure CCF_fail_B\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_CCF_fail_B]  =  TRUE,already_standby_OF_CCF_fail_B  =  FALSE,already_required_OF_CCF_fail_B  =  FALSE" << endl;
		list.push_back(make_tuple(2, 0.0001, "INS", 2));
	}
	if ((boolState[failI_OF_CCF_fail_B] == false) && boolState[to_be_fired_OF_CCF_fail_B])
	{
		cout << "3 :  INS_SUB_COUNT (2) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_CCF_fail_B]  =  FALSE,already_required_OF_CCF_fail_B  =  FALSE" << endl;
		list.push_back(make_tuple(3, 0.9999, "INS", 2));
	}
	if ((boolState[failI_OF_CCF_fail_C] == false) && boolState[to_be_fired_OF_CCF_fail_C])
	{
		cout << "4 :  INS_SUB_COUNT (3) |FAULT | failI  LABEL \"instantaneous failure CCF_fail_C\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_CCF_fail_C]  =  TRUE,already_standby_OF_CCF_fail_C  =  FALSE,already_required_OF_CCF_fail_C  =  FALSE" << endl;
		list.push_back(make_tuple(4, 0.0001, "INS", 3));
	}
	if ((boolState[failI_OF_CCF_fail_C] == false) && boolState[to_be_fired_OF_CCF_fail_C])
	{
		cout << "5 :  INS_SUB_COUNT (3) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_CCF_fail_C]  =  FALSE,already_required_OF_CCF_fail_C  =  FALSE" << endl;
	...
	if ((boolState[failF_OF_Indep_fail_A] == false) && boolState[required_OF_Indep_fail_A])
	{
		cout << "6 : xx10_OF_Indep_fail_A : FAULT failF  LABEL \"failure in operation Indep_fail_A\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Indep_fail_A]  =  TRUE" << endl;
		list.push_back(make_tuple(6, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_Indep_fail_B] == false) && boolState[required_OF_Indep_fail_B])
	{
		cout << "7 : xx10_OF_Indep_fail_B : FAULT failF  LABEL \"failure in operation Indep_fail_B\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Indep_fail_B]  =  TRUE" << endl;
		list.push_back(make_tuple(7, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_Indep_fail_C] == false) && boolState[required_OF_Indep_fail_C])
	{
		cout << "8 : xx10_OF_Indep_fail_C : FAULT failF  LABEL \"failure in operation Indep_fail_C\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Indep_fail_C]  =  TRUE" << endl;
		list.push_back(make_tuple(8, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_Shock] == false) && boolState[required_OF_Shock])
	{
		cout << "9 : xx10_OF_Shock : FAULT failF  LABEL \"failure in operation Shock\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Shock]  =  TRUE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_03_CCF_No_Trim_No_repair::fireinsttransitiongroup(std::string user_input_ins)
