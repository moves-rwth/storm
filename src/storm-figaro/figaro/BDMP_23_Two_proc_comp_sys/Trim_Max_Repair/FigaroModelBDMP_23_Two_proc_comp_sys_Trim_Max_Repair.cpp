#include <iostream>
#include "FigaroModelBDMP_23_Two_proc_comp_sys_Trim_Max_Repair.h"
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::init()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_D11] == true )
	{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_Max_Repair::fireinsttransitiongroup(std::string user_input_ins)
