#include <iostream>
#include "FigaroModelBDMP_23_Two_proc_comp_sys_Trim_article_No_Repair.h"
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::init()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failF_OF_D11] == false) && (boolState[required_OF_D11] && boolState[relevant_evt_OF_D11])) 
	{
	...
	if ((boolState[failF_OF_D12] == false) && ((boolState[required_OF_D12] &&  boolState[relevant_evt_OF_D12]) && ( !boolState[failS_OF_D12]))) 
	{
	...
	if ((boolState[failS_OF_D12] == false) && ((( !boolState[required_OF_D12]) &&  boolState[relevant_evt_OF_D12]) && ( !boolState[failF_OF_D12]))) 
	{
	...
	if ((boolState[failF_OF_D21] == false) && (boolState[required_OF_D21] && boolState[relevant_evt_OF_D21])) 
	{
	...
	if ((boolState[failF_OF_D22] == false) && ((boolState[required_OF_D22] &&  boolState[relevant_evt_OF_D22]) && ( !boolState[failS_OF_D22]))) 
	{
	...
	if ((boolState[failS_OF_D22] == false) && ((( !boolState[required_OF_D22]) &&  boolState[relevant_evt_OF_D22]) && ( !boolState[failF_OF_D22]))) 
	{
	...
	if ((boolState[failF_OF_M1] == false) && (boolState[required_OF_M1] && boolState[relevant_evt_OF_M1])) 
	{
	...
	if ((boolState[failF_OF_M2] == false) && (boolState[required_OF_M2] && boolState[relevant_evt_OF_M2])) 
	{
	...
	if ((boolState[failF_OF_M3] == false) && ((boolState[required_OF_M3] && boolState[relevant_evt_OF_M3]) && ( !boolState[failS_OF_M3]))) 
	{
	...
	if ((boolState[failS_OF_M3] == false) && ((( !boolState[required_OF_M3]) &&  boolState[relevant_evt_OF_M3]) && ( !boolState[failF_OF_M3]))) 
	{
	...
	if ((boolState[failF_OF_N] == false) && (boolState[required_OF_N] && boolState[relevant_evt_OF_N])) 
	{
	...
	if ((boolState[failF_OF_PS] == false) && (boolState[required_OF_PS] && boolState[relevant_evt_OF_PS])) 
	{
	...
	if ((boolState[failF_OF_Pa] == false) && (boolState[required_OF_Pa] && boolState[relevant_evt_OF_Pa])) 
	{
	...
	if ((boolState[failF_OF_Pb] == false) && (boolState[required_OF_Pb] && boolState[relevant_evt_OF_Pb])) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_Disk1_loss] && ( !boolState[S_OF_Disk1_loss])) || (   !boolState[S_OF_D12]) )
	{
	...
	if ((boolState[relevant_evt_OF_Disk2_loss] && ( !boolState[S_OF_Disk2_loss])) || (   !boolState[S_OF_D22]) )
	{
...
void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair::fireinsttransitiongroup(std::string user_input_ins)
