    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_BDMP_23_Two_proc_comp_sys_Trim_article_No_Repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
