#include <iostream>
#include "FigaroModelBDMP_09_Phases_Trim_Article_No_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::init()
{
	...
	FIRE_xx47_OF_phase_1_INS_4 = false;
	FIRE_xx43_a_OF_phase_2 = false;
	FIRE_xx47_OF_phase_2_INS_6 = false;

}

void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::fireOccurrence(int numFire)
{
	...
	if (numFire == 4)
	{
		FIRE_xx47_OF_phase_1_INS_4 = true;
	}
	...
	if (numFire == 6)
	{
		FIRE_xx47_OF_phase_2_INS_6 = true;
	}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::showFireableOccurrences()
{
	...
	if (boolState[start_phase_OF_phase_1])
	{
		cout << "4 :  INS_SUB_COUNT (1) |TRANSITION | start  LABEL \"start of phase phase_1\" | DIST INS (1) | INDUCING boolState[in_progress_OF_phase_1]  =  TRUE,start_phase_OF_phase_1  =  FALSE" << endl;
		list.push_back(make_tuple(4, 1, "INS", 1));
	}
	if (boolState[start_phase_OF_phase_2])
	{
		cout << "6 :  INS_SUB_COUNT (2) |TRANSITION | start  LABEL \"start of phase phase_2\" | DIST INS (1) | INDUCING boolState[in_progress_OF_phase_2]  =  TRUE,start_phase_OF_phase_2  =  FALSE" << endl;
		list.push_back(make_tuple(6, 1, "INS", 2));
	}
        if (list.size() > 0)
        {
	...
	if ((boolState[failF_OF_Cpt_B] == false) && (boolState[required_OF_Cpt_B] && boolState[relevant_evt_OF_Cpt_B]))
	{
		cout << "1 : xx10_OF_Cpt_B : FAULT failF  LABEL \"failure in operation Cpt_B\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Cpt_B]  =  TRUE" << endl;
		list.push_back(make_tuple(1, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_Cpt_C] == false) && (boolState[required_OF_Cpt_C] && boolState[relevant_evt_OF_Cpt_C]))
	{
		cout << "2 : xx10_OF_Cpt_C : FAULT failF  LABEL \"failure in operation Cpt_C\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Cpt_C]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 0.0001, "EXP", 0));
	}
	if (boolState[in_progress_OF_phase_1])
	{
		cout << "3 : xx43_a_OF_phase_1 : TRANSITION end  LABEL \"End of phase phase_1\"  DIST EXP (0.1)  INDUCING boolState[in_progress_OF_phase_1]  =  FALSE" << endl;
		list.push_back(make_tuple(3, 0.1, "EXP", 0));
	}
	if (boolState[in_progress_OF_phase_2])
	{
		cout << "5 : xx43_a_OF_phase_2 : TRANSITION end  LABEL \"End of phase phase_2\"  DIST EXP (0.1)  INDUCING boolState[in_progress_OF_phase_2]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair::fireinsttransitiongroup(std::string user_input_ins)
