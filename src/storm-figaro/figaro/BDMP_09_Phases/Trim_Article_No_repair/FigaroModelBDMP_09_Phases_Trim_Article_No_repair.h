    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_BDMP_09_Phases_Trim_Article_No_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_AND_1" , 0},
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
            ...
            bool FIRE_xx47_OF_phase_1_INS_4;
            bool FIRE_xx43_a_OF_phase_2;
            bool FIRE_xx47_OF_phase_2_INS_6;
