    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_BDMP_13_Share1_Trim_Article_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_BDMP_13_Share1_Trim_Article_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_AND_1" , 0},
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
            ...
            bool FIRE_xx11_OF_FailureOf_A;
            bool FIRE_xx10_OF_FailureOf_B;
            bool FIRE_xx11_OF_FailureOf_B;
            bool FIRE_xx10_OF_FailureOf_S;
            bool FIRE_xx11_OF_FailureOf_S;
            bool FIRE_xx23_OF_OnDemandFailureOf_S_INS_6;
            bool FIRE_xx23_OF_OnDemandFailureOf_S_INS_7;
            bool FIRE_xx24_OF_OnDemandFailureOf_S;
