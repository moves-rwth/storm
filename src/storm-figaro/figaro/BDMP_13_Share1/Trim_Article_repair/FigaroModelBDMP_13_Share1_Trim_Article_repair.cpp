#include <iostream>
#include "FigaroModelBDMP_13_Share1_Trim_Article_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::init()
{
	...
	FIRE_xx11_OF_FailureOf_A = false;
	FIRE_xx10_OF_FailureOf_B = false;
	FIRE_xx11_OF_FailureOf_B = false;
	FIRE_xx10_OF_FailureOf_S = false;
	FIRE_xx11_OF_FailureOf_S = false;
	FIRE_xx23_OF_OnDemandFailureOf_S_INS_6 = false;
	FIRE_xx23_OF_OnDemandFailureOf_S_INS_7 = false;
	FIRE_xx24_OF_OnDemandFailureOf_S = false;

}

void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::fireOccurrence(int numFire)
{
	...
	if (numFire == 5)
	{
		FIRE_xx11_OF_FailureOf_S = true;
	}

	if (numFire == 6)
	{
		FIRE_xx23_OF_OnDemandFailureOf_S_INS_6 = true;
	}

	if (numFire == 7)
	{
		FIRE_xx23_OF_OnDemandFailureOf_S_INS_7 = true;
	}

	if (numFire == 8)
	{
		FIRE_xx24_OF_OnDemandFailureOf_S = true;
	}
...
&& boolState[relevant_evt_OF_FailureOf_A])) 
	{
	...
	// Occurrence xx11_OF_FailureOf_A
	if (boolState[failF_OF_FailureOf_A] == true) 
	{
		 
		if (FIRE_xx11_OF_FailureOf_A)
		{
			boolState[failF_OF_FailureOf_A]  =  false;
			FIRE_xx11_OF_FailureOf_A = false;
		}
...
&& boolState[relevant_evt_OF_FailureOf_B])) 
	{
	...
	// Occurrence xx11_OF_FailureOf_B
	if (boolState[failF_OF_FailureOf_B] == true) 
	{
		 
		if (FIRE_xx11_OF_FailureOf_B)
		{
			boolState[failF_OF_FailureOf_B]  =  false;
			FIRE_xx11_OF_FailureOf_B = false;
		}
...
&& boolState[relevant_evt_OF_FailureOf_S])) 
	{
	...
	// Occurrence xx11_OF_FailureOf_S
	if (boolState[failF_OF_FailureOf_S] == true) 
	{
		 
		if (FIRE_xx11_OF_FailureOf_S)
		{
			boolState[failF_OF_FailureOf_S]  =  false;
			FIRE_xx11_OF_FailureOf_S = false;
		}
	...
	if ((boolState[failI_OF_OnDemandFailureOf_S] == false) && (boolState[to_be_fired_OF_OnDemandFailureOf_S] && boolState[relevant_evt_OF_OnDemandFailureOf_S])) 
	{
	
		
		if (FIRE_xx23_OF_OnDemandFailureOf_S_INS_6) 
		{
	...
	if ((boolState[failI_OF_OnDemandFailureOf_S] == false) && (boolState[to_be_fired_OF_OnDemandFailureOf_S] && boolState[relevant_evt_OF_OnDemandFailureOf_S])) 
	{
		...
		if (FIRE_xx23_OF_OnDemandFailureOf_S_INS_7) 
		{
			boolState[already_standby_OF_OnDemandFailureOf_S]  =  false;
			boolState[already_required_OF_OnDemandFailureOf_S]  =  false;
			FIRE_xx23_OF_OnDemandFailureOf_S_INS_7 = false;
	...
	// Occurrence xx24_OF_OnDemandFailureOf_S
	if (boolState[failI_OF_OnDemandFailureOf_S] == true) 
	{
		 
		if (FIRE_xx24_OF_OnDemandFailureOf_S)
		{
			boolState[failI_OF_OnDemandFailureOf_S]  =  false;
			FIRE_xx24_OF_OnDemandFailureOf_S = false;
		}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::showFireableOccurrences()
{
	...
	if ((boolState[failI_OF_OnDemandFailureOf_S] == false) && (boolState[to_be_fired_OF_OnDemandFailureOf_S] && boolState[relevant_evt_OF_OnDemandFailureOf_S]))
	{
		cout << "6 :  INS_SUB_COUNT (1) |FAULT | failI  LABEL \"instantaneous failure OnDemandFailureOf_S\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_OnDemandFailureOf_S]  =  TRUE,already_standby_OF_OnDemandFailureOf_S  =  FALSE,already_required_OF_OnDemandFailureOf_S  =  FALSE" << endl;
		list.push_back(make_tuple(6, 0.0001, "INS", 1));
	}
	if ((boolState[failI_OF_OnDemandFailureOf_S] == false) && (boolState[to_be_fired_OF_OnDemandFailureOf_S] && boolState[relevant_evt_OF_OnDemandFailureOf_S]))
	{
		cout << "7 :  INS_SUB_COUNT (1) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_OnDemandFailureOf_S]  =  FALSE,already_required_OF_OnDemandFailureOf_S  =  FALSE" << endl;
	...
	if ((boolState[failF_OF_FailureOf_A] == false) && (boolState[required_OF_FailureOf_A] && boolState[relevant_evt_OF_FailureOf_A]))
	{
	...
	if (boolState[failF_OF_FailureOf_A] == true)
	{
		cout << "1 : xx11_OF_FailureOf_A : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_FailureOf_A]  =  FALSE" << endl;
		list.push_back(make_tuple(1, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_FailureOf_B] == false) && (boolState[required_OF_FailureOf_B] && boolState[relevant_evt_OF_FailureOf_B]))
	{
		cout << "2 : xx10_OF_FailureOf_B : FAULT failF  LABEL \"failure in operation FailureOf_B\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_FailureOf_B]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_FailureOf_B] == true)
	{
		cout << "3 : xx11_OF_FailureOf_B : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_FailureOf_B]  =  FALSE" << endl;
		list.push_back(make_tuple(3, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_FailureOf_S] == false) && (boolState[required_OF_FailureOf_S] && boolState[relevant_evt_OF_FailureOf_S]))
	{
		cout << "4 : xx10_OF_FailureOf_S : FAULT failF  LABEL \"failure in operation FailureOf_S\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_FailureOf_S]  =  TRUE" << endl;
		list.push_back(make_tuple(4, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_FailureOf_S] == true)
	{
		cout << "5 : xx11_OF_FailureOf_S : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_FailureOf_S]  =  FALSE" << endl;
		list.push_back(make_tuple(5, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_OnDemandFailureOf_S] == true)
	{
		cout << "8 : xx24_OF_OnDemandFailureOf_S : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_OnDemandFailureOf_S]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_FailureOf_A] == true )
	{
...
void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ( !boolState[S_OF_S_unavailable] )
	{
...
void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_13_Share1_Trim_Article_repair::fireinsttransitiongroup(std::string user_input_ins)
