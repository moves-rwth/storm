#include <iostream>
#include "FigaroModelBDMP_07Excl1_No_trim_No_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::init()
{
...
void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failF_OF_cptA] == false) && boolState[required_OF_cptA]) 
	{
	...
	if ((boolState[failF_OF_cptB] == false) && boolState[required_OF_cptB]) 
	{
	...
	if ((boolState[failF_OF_cptC] == false) && boolState[required_OF_cptC]) 
	{
	...
	if ((boolState[failF_OF_cptD] == false) && boolState[required_OF_cptD]) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_cptB] == false) && boolState[required_OF_cptB])
	{
		cout << "1 : xx10_OF_cptB : FAULT failF  LABEL \"failure in operation cptB\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_cptB]  =  TRUE" << endl;
		list.push_back(make_tuple(1, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_cptC] == false) && boolState[required_OF_cptC])
	{
		cout << "2 : xx10_OF_cptC : FAULT failF  LABEL \"failure in operation cptC\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_cptC]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_cptD] == false) && boolState[required_OF_cptD])
	{
		cout << "3 : xx10_OF_cptD : FAULT failF  LABEL \"failure in operation cptD\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_cptD]  =  TRUE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_AND_1] && ( !boolState[S_OF_AND_1])) || ((  boolState[relevant_evt_OF_cptB] && ( !boolState[S_OF_cptB])) || (boolState[relevant_evt_OF_cptC] && ( !boolState[S_OF_cptC]))) )
	{
	...
	if ((boolState[relevant_evt_OF_AND_2] && ( !boolState[S_OF_AND_2])) || ((  boolState[relevant_evt_OF_cptA] && ( !boolState[S_OF_cptA])) || (boolState[relevant_evt_OF_cptD] && ( !boolState[S_OF_cptD]))) )
	{
...
void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_07Excl1_No_trim_No_repair::fireinsttransitiongroup(std::string user_input_ins)
