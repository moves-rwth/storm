#include <iostream>
#include "FigaroModelBDMP_19_ESREL_2013_v2_No_trim_No_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::init()
{
...
void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::fireOccurrence(int numFire)
{
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failF_OF_course_changed] == false) && boolState[required_OF_course_changed]) 
	{
	...
	if ((boolState[failF_OF_radar] == false) && boolState[required_OF_radar]) 
	{
	...
	if ((boolState[failF_OF_radar_1] == false) && boolState[required_OF_radar_1]) 
	{
	...
	if ((boolState[failF_OF_visual] == false) && boolState[required_OF_visual]) 
	{
	...
	if ((boolState[failF_OF_visual_1] == false) && boolState[required_OF_visual_1]) 
	{
	...
	if ((boolState[failF_OF_warning] == false) && boolState[required_OF_warning]) 
	{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_course_changed] == true )
	{
...
void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_collision_avoided] && ( !boolState[S_OF_collision_avoided])) || (boolState[relevant_evt_OF_course_changed] && (   !boolState[S_OF_course_changed])) )
	{
	...
	if ((boolState[relevant_evt_OF_detection_by_platform] && ( !boolState[S_OF_detection_by_platform])) || (boolState[relevant_evt_OF_warning] && ( !  boolState[S_OF_warning])) )
	{
	...
	if (((boolState[relevant_evt_OF_too_late] && ( !boolState[S_OF_too_late])) || (  boolState[relevant_evt_OF_visual] && ( !boolState[S_OF_visual]))) || (  boolState[relevant_evt_OF_visual_1] && ( !boolState[S_OF_visual_1])) )
	{
		boolState[relevant_evt_OF_radar_and_visual]  =  true;
	}

	if (((boolState[relevant_evt_OF_radar] && ( !boolState[S_OF_radar])) || (  boolState[relevant_evt_OF_radar_1] && ( !boolState[S_OF_radar_1]))) || (  boolState[relevant_evt_OF_radar_and_visual] && ( !boolState[S_OF_radar_and_visual])) )
	{
...
void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_19_ESREL_2013_v2_No_trim_No_repair::fireinsttransitiongroup(std::string user_input_ins)
