    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_BDMP_19_ESREL_2013_v2_Trim_Article_No_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_BDMP_19_ESREL_2013_v2_Trim_Article_No_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_UE_1" , 0},
            	{"already_S_OF_UE_1" , 1},
            	{"S_OF_UE_1" , 2},
