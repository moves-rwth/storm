#include <iostream>
#include "FigaroModelBDMP_15_Trim_Article_No_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::init()
{
...
void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_A2] == false) && (boolState[required_OF_A2] && boolState[relevant_evt_OF_A2]))
	{
		cout << "1 : xx10_OF_A2 : FAULT failF  LABEL \"failure in operation A2\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_A2]  =  TRUE" << endl;
		list.push_back(make_tuple(1, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_B1] == false) && (boolState[required_OF_B1] && boolState[relevant_evt_OF_B1]))
	{
		cout << "2 : xx10_OF_B1 : FAULT failF  LABEL \"failure in operation B1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_B1]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_B2] == false) && (boolState[required_OF_B2] && boolState[relevant_evt_OF_B2]))
	{
		cout << "3 : xx10_OF_B2 : FAULT failF  LABEL \"failure in operation B2\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_B2]  =  TRUE" << endl;
		list.push_back(make_tuple(3, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_K1] == false) && (boolState[required_OF_K1] && boolState[relevant_evt_OF_K1]))
	{
		cout << "4 : xx10_OF_K1 : FAULT failF  LABEL \"failure in operation K1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_K1]  =  TRUE" << endl;
		list.push_back(make_tuple(4, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_K2] == false) && (boolState[required_OF_K2] && boolState[relevant_evt_OF_K2]))
	{
		cout << "5 : xx10_OF_K2 : FAULT failF  LABEL \"failure in operation K2\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_K2]  =  TRUE" << endl;
		list.push_back(make_tuple(5, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_K3] == false) && (boolState[required_OF_K3] && boolState[relevant_evt_OF_K3]))
	{
		cout << "6 : xx10_OF_K3 : FAULT failF  LABEL \"failure in operation K3\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_K3]  =  TRUE" << endl;
		list.push_back(make_tuple(6, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_SF_1] == false) && ((boolState[required_OF_SF_1] && boolState[relevant_evt_OF_SF_1]) && ( !boolState[failS_OF_SF_1])))
	{
		cout << "7 : xx17_OF_SF_1 : FAULT failF  LABEL \"failure in operation SF_1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_SF_1]  =  TRUE" << endl;
		list.push_back(make_tuple(7, 0.0001, "EXP", 0));
	}
	if ((boolState[failS_OF_SF_1] == false) && ((( !boolState[required_OF_SF_1]) && boolState[relevant_evt_OF_SF_1]) && ( !boolState[failF_OF_SF_1])))
	{
		cout << "8 : xx18_OF_SF_1 : FAULT failS  LABEL \"standby failure SF_1\"  DIST EXP (1e-05)  INDUCING boolState[failS_OF_SF_1]  =  TRUE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_15_Trim_Article_No_repair::fireinsttransitiongroup(std::string user_input_ins)
