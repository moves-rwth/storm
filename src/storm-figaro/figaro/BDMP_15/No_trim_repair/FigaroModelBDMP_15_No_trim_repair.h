    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_BDMP_15_No_trim_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_BDMP_15_No_trim_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_A1" , 0},
            	{"already_S_OF_A1" , 1},
            	{"S_OF_A1" , 2},
