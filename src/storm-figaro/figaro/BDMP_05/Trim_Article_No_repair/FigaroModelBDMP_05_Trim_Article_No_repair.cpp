#include <iostream>
#include "FigaroModelBDMP_05_Trim_Article_No_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::init()
{
...
void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::showFireableOccurrences()
{
	...
	if ((boolState[failF_OF_Transfo1] == false) && (boolState[required_OF_Transfo1] && boolState[relevant_evt_OF_Transfo1]))
	{
		cout << "6 : xx10_OF_Transfo1 : FAULT failF  LABEL \"failure in operation Transfo1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Transfo1]  =  TRUE" << endl;
		list.push_back(make_tuple(6, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_Transfo2] == false) && (boolState[required_OF_Transfo2] && boolState[relevant_evt_OF_Transfo2]))
	{
		cout << "7 : xx10_OF_Transfo2 : FAULT failF  LABEL \"failure in operation Transfo2\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Transfo2]  =  TRUE" << endl;
		list.push_back(make_tuple(7, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_dies_generator] == false) && (boolState[required_OF_dies_generator] && boolState[relevant_evt_OF_dies_generator]))
	{
		cout << "8 : xx10_OF_dies_generator : FAULT failF  LABEL \"failure in operation dies_generator\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_dies_generator]  =  TRUE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_05_Trim_Article_No_repair::fireinsttransitiongroup(std::string user_input_ins)
