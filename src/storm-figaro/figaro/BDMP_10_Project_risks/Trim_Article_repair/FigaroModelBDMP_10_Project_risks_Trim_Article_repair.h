    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_BDMP_10_Project_risks_Trim_Article_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_BDMP_10_Project_risks_Trim_Article_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_AND_1" , 0},
...
//            std::array<int, numEnumState> backupEnumState;
		...
		/* ---------- DECLARATION OF CONSTANTS ------------ */
            ...
            bool FIRE_xx11_OF_F_3_1;
            bool FIRE_xx10_OF_F_4;
            bool FIRE_xx11_OF_F_4;
            bool FIRE_xx23_OF_I_1_INS_10;
            bool FIRE_xx23_OF_I_1_INS_11;
