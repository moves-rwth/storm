#include <iostream>
#include "FigaroModelBDMP_10_Project_risks_Trim_Article_No_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::init()
{
	...
	FIRE_xx23_OF_I_1_INS_5 = false;
	FIRE_xx23_OF_I_1_INS_6 = false;

}

void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::fireOccurrence(int numFire)
{
	...
	if (numFire == 5)
	{
		FIRE_xx23_OF_I_1_INS_5 = true;
	}

	if (numFire == 6)
	{
		FIRE_xx23_OF_I_1_INS_6 = true;
	}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::showFireableOccurrences()
{
	...
	{
		cout << "5 :  INS_SUB_COUNT (1) |FAULT | failI  LABEL \"instantaneous failure I_1\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_I_1]  =  TRUE,already_standby_OF_I_1  =  FALSE,already_required_OF_I_1  =  FALSE" << endl;
		list.push_back(make_tuple(5, 0.0001, "INS", 1));
	}
	if ((boolState[failI_OF_I_1] == false) && (boolState[to_be_fired_OF_I_1] &&	boolState[relevant_evt_OF_I_1]))
	{
		cout << "6 :  INS_SUB_COUNT (1) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_I_1]  =  FALSE,already_required_OF_I_1  =  FALSE" << endl;
		list.push_back(make_tuple(6, 0.9999, "INS", 1));
	}
        if (list.size() > 0)
        {
	...
	if ((boolState[failF_OF_F_2] == false) && (boolState[required_OF_F_2] && boolState[relevant_evt_OF_F_2]))
	{
		cout << "1 : xx10_OF_F_2 : FAULT failF  LABEL \"failure in operation F_2\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_F_2]  =  TRUE" << endl;
		list.push_back(make_tuple(1, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_F_3] == false) && (boolState[required_OF_F_3] && boolState[relevant_evt_OF_F_3]))
	{
		cout << "2 : xx10_OF_F_3 : FAULT failF  LABEL \"failure in operation F_3\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_F_3]  =  TRUE" << endl;
		list.push_back(make_tuple(2, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_F_3_1] == false) && (boolState[required_OF_F_3_1] && boolState[relevant_evt_OF_F_3_1]))
	{
		cout << "3 : xx10_OF_F_3_1 : FAULT failF  LABEL \"failure in operation F_3_1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_F_3_1]  =  TRUE" << endl;
		list.push_back(make_tuple(3, 0.0001, "EXP", 0));
	}
	if ((boolState[failF_OF_F_4] == false) && (boolState[required_OF_F_4] && boolState[relevant_evt_OF_F_4]))
	{
		cout << "4 : xx10_OF_F_4 : FAULT failF  LABEL \"failure in operation F_4\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_F_4]  =  TRUE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_Major_risk] && ( !boolState[S_OF_Major_risk])) || (   !boolState[S_OF_AND_1_1]) )
	{
	...
	if ((boolState[relevant_evt_OF_AND_1] && ( !boolState[S_OF_AND_1])) || ( !boolState[S_OF_F_4]) )
	{
	...
	if ((boolState[relevant_evt_OF_AND_1_1] && ( !boolState[S_OF_AND_1_1])) || ( !boolState[S_OF_I_1]) )
	{
...
void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_10_Project_risks_Trim_Article_No_repair::fireinsttransitiongroup(std::string user_input_ins)
