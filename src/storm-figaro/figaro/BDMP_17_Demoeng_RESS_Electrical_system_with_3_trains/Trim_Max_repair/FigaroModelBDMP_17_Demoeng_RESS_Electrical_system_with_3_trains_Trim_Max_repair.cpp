#include <iostream>
#include "FigaroModelBDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::init()
{
	...
	FIRE_xx23_OF_RO_CB_up_1_INS_21 = false;
	FIRE_xx23_OF_RO_CB_up_1_INS_22 = false;
	FIRE_xx24_OF_RO_CB_up_1 = false;
	FIRE_xx23_OF_RO_CB_up_2_INS_24 = false;
	FIRE_xx23_OF_RO_CB_up_2_INS_25 = false;
	FIRE_xx24_OF_RO_CB_up_2 = false;
	FIRE_xx23_OF_RS_dies_INS_27 = false;
	FIRE_xx23_OF_RS_dies_INS_28 = false;
...
void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::fireOccurrence(int numFire)
{
	...
	if (numFire == 21)
	{
		FIRE_xx23_OF_RO_CB_up_1_INS_21 = true;
	}

	if (numFire == 22)
	{
		FIRE_xx23_OF_RO_CB_up_1_INS_22 = true;
	}

	if (numFire == 23)
	{
		FIRE_xx24_OF_RO_CB_up_1 = true;
	}

	if (numFire == 24)
	{
		FIRE_xx23_OF_RO_CB_up_2_INS_24 = true;
	}

	if (numFire == 25)
	{
		FIRE_xx23_OF_RO_CB_up_2_INS_25 = true;
	}

	if (numFire == 26)
	{
		FIRE_xx24_OF_RO_CB_up_2 = true;
	}

	if (numFire == 27)
	{
		FIRE_xx23_OF_RS_dies_INS_27 = true;
	}

	if (numFire == 28)
	{
		FIRE_xx23_OF_RS_dies_INS_28 = true;
	}
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	&& boolState[relevant_evt_OF_RO_CB_up_1])) 
	{
		...
		if (FIRE_xx23_OF_RO_CB_up_1_INS_21) 
		{
	...
	&& boolState[relevant_evt_OF_RO_CB_up_1])) 
	{
		...
		if (FIRE_xx23_OF_RO_CB_up_1_INS_22) 
		{
			boolState[already_standby_OF_RO_CB_up_1]  =  false;
			boolState[already_required_OF_RO_CB_up_1]  =  false;
			FIRE_xx23_OF_RO_CB_up_1_INS_22 = false;
	...
	// Occurrence xx24_OF_RO_CB_up_1
	if (boolState[failI_OF_RO_CB_up_1] == true) 
	{
		 
		if (FIRE_xx24_OF_RO_CB_up_1)
		{
			boolState[failI_OF_RO_CB_up_1]  =  false;
			FIRE_xx24_OF_RO_CB_up_1 = false;
		}
	...
	&& boolState[relevant_evt_OF_RO_CB_up_2])) 
	{
		...
		if (FIRE_xx23_OF_RO_CB_up_2_INS_24) 
		{
	...
	&& boolState[relevant_evt_OF_RO_CB_up_2])) 
	{
		...
		if (FIRE_xx23_OF_RO_CB_up_2_INS_25) 
		{
			boolState[already_standby_OF_RO_CB_up_2]  =  false;
			boolState[already_required_OF_RO_CB_up_2]  =  false;
			FIRE_xx23_OF_RO_CB_up_2_INS_25 = false;
	...
	// Occurrence xx24_OF_RO_CB_up_2
	if (boolState[failI_OF_RO_CB_up_2] == true) 
	{
		 
		if (FIRE_xx24_OF_RO_CB_up_2)
		{
			boolState[failI_OF_RO_CB_up_2]  =  false;
			FIRE_xx24_OF_RO_CB_up_2 = false;
		}
	...
	boolState[relevant_evt_OF_RS_dies])) 
	{
		...
		if (FIRE_xx23_OF_RS_dies_INS_27) 
		{
	...
	boolState[relevant_evt_OF_RS_dies])) 
	{
		...
		if (FIRE_xx23_OF_RS_dies_INS_28) 
		{
			boolState[already_standby_OF_RS_dies]  =  false;
			boolState[already_required_OF_RS_dies]  =  false;
			FIRE_xx23_OF_RS_dies_INS_28 = false;
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::showFireableOccurrences()
{
	...
	{
		cout << "21 :  INS_SUB_COUNT (4) |FAULT | failI  LABEL \"instantaneous failure RO_CB_up_1\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_RO_CB_up_1]  =  TRUE,already_standby_OF_RO_CB_up_1  =  FALSE,already_required_OF_RO_CB_up_1  =  FALSE" << endl;
		list.push_back(make_tuple(21, 0.0001, "INS", 4));
	}
	if ((boolState[failI_OF_RO_CB_up_1] == false) && (boolState[to_be_fired_OF_RO_CB_up_1] && boolState[relevant_evt_OF_RO_CB_up_1]))
	{
		cout << "22 :  INS_SUB_COUNT (4) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_RO_CB_up_1]  =  FALSE,already_required_OF_RO_CB_up_1  =  FALSE" << endl;
	...
	{
		cout << "24 :  INS_SUB_COUNT (5) |FAULT | failI  LABEL \"instantaneous failure RO_CB_up_2\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_RO_CB_up_2]  =  TRUE,already_standby_OF_RO_CB_up_2  =  FALSE,already_required_OF_RO_CB_up_2  =  FALSE" << endl;
		list.push_back(make_tuple(24, 0.0001, "INS", 5));
	}
	if ((boolState[failI_OF_RO_CB_up_2] == false) && (boolState[to_be_fired_OF_RO_CB_up_2] && boolState[relevant_evt_OF_RO_CB_up_2]))
	{
		cout << "25 :  INS_SUB_COUNT (5) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_RO_CB_up_2]  =  FALSE,already_required_OF_RO_CB_up_2  =  FALSE" << endl;
		list.push_back(make_tuple(25, 0.9999, "INS", 5));
	}
	if ((boolState[failI_OF_RS_dies] == false) && (boolState[to_be_fired_OF_RS_dies] &&	boolState[relevant_evt_OF_RS_dies]))
	{
		cout << "27 :  INS_SUB_COUNT (6) |FAULT | failI  LABEL \"instantaneous failure RS_dies\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_RS_dies]  =  TRUE,already_standby_OF_RS_dies  =  FALSE,already_required_OF_RS_dies  =  FALSE" << endl;
		list.push_back(make_tuple(27, 0.0001, "INS", 6));
	}
	if ((boolState[failI_OF_RS_dies] == false) && (boolState[to_be_fired_OF_RS_dies] &&	boolState[relevant_evt_OF_RS_dies]))
	{
		cout << "28 :  INS_SUB_COUNT (6) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_RS_dies]  =  FALSE,already_required_OF_RS_dies  =  FALSE" << endl;
		list.push_back(make_tuple(28, 0.9999, "INS", 6));
	}
        if (list.size() > 0)
        {
	...
	if (boolState[failI_OF_RO_CB_up_1] == true)
	{
		cout << "23 : xx24_OF_RO_CB_up_1 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_RO_CB_up_1]  =  FALSE" << endl;
		list.push_back(make_tuple(23, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_RO_CB_up_2] == true)
	{
		cout << "26 : xx24_OF_RO_CB_up_2 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_RO_CB_up_2]  =  FALSE" << endl;
		list.push_back(make_tuple(26, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_RS_dies] == true)
	{
		cout << "29 : xx24_OF_RS_dies : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_RS_dies]  =  FALSE" << endl;
		list.push_back(make_tuple(29, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_Transfo1] == false) && (boolState[required_OF_Transfo1] && boolState[relevant_evt_OF_Transfo1]))
	{
		cout << "30 : xx10_OF_Transfo1 : FAULT failF  LABEL \"failure in operation Transfo1\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Transfo1]  =  TRUE" << endl;
		list.push_back(make_tuple(30, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_Transfo1] == true)
	{
		cout << "31 : xx11_OF_Transfo1 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_Transfo1]  =  FALSE" << endl;
		list.push_back(make_tuple(31, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_Transfo2] == false) && (boolState[required_OF_Transfo2] && boolState[relevant_evt_OF_Transfo2]))
	{
		cout << "32 : xx10_OF_Transfo2 : FAULT failF  LABEL \"failure in operation Transfo2\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Transfo2]  =  TRUE" << endl;
		list.push_back(make_tuple(32, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_Transfo2] == true)
	{
		cout << "33 : xx11_OF_Transfo2 : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_Transfo2]  =  FALSE" << endl;
		list.push_back(make_tuple(33, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_dies_generator] == false) && (boolState[required_OF_dies_generator] && boolState[relevant_evt_OF_dies_generator]))
	{
		cout << "34 : xx10_OF_dies_generator : FAULT failF  LABEL \"failure in operation dies_generator\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_dies_generator]  =  TRUE" << endl;
		list.push_back(make_tuple(34, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_dies_generator] == true)
	{
		cout << "35 : xx11_OF_dies_generator : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_dies_generator]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_CB_dies] == true )
	{
...
void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if (((boolState[relevant_evt_OF_PropagationShortCircuitTransfo1] && ( !boolState[S_OF_PropagationShortCircuitTransfo1])) || (boolState[relevant_evt_OF_LossOfLine_1] && ( !boolState[S_OF_LossOfLine_1]))) || (boolState[relevant_evt_OF_RO_CB_up_1] && ( !boolState[S_OF_RO_CB_up_1])) )
	{
	...
	if (((boolState[relevant_evt_OF_LossOfLine2] && ( !boolState[S_OF_LossOfLine2])) || (boolState[relevant_evt_OF_PropagationShortCircuitTransfo2] && ( !boolState[S_OF_PropagationShortCircuitTransfo2]))) || (boolState[relevant_evt_OF_RO_CB_up_2] && ( !boolState[S_OF_RO_CB_up_2])) )
	{
...
void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_17_Demoeng_RESS_Electrical_system_with_3_trains_Trim_Max_repair::fireinsttransitiongroup(std::string user_input_ins)
