    ...
    namespace storm{
        namespace figaro{
        class FigaroProgram_BDMP_08_PC_No_trim_repair: public storm::figaro::FigaroProgram{
        public:
        FigaroProgram_BDMP_08_PC_No_trim_repair(): FigaroProgram(//            std::map<std::string, size_t> mFigaroboolelementindex =
                    {  
            	{"required_OF_AND_1" , 0},
