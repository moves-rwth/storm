#include <iostream>
#include "FigaroModelBDMP_08_PC_Trim_Article_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::init()
{
	...
	FIRE_xx19_OF_Cpu = false;
	FIRE_xx10_OF_DisplayUnit = false;
	FIRE_xx11_OF_DisplayUnit = false;
	FIRE_xx10_OF_Fan = false;
	FIRE_xx11_OF_Fan = false;
	FIRE_xx10_OF_FloppyDrive = false;
	FIRE_xx11_OF_FloppyDrive = false;
	FIRE_xx10_OF_FloppyDriveInUse = false;
	FIRE_xx11_OF_FloppyDriveInUse = false;
	FIRE_xx10_OF_HardDrive = false;
	FIRE_xx11_OF_HardDrive = false;
	FIRE_xx23_OF_ManipulationError_INS_13 = false;
	FIRE_xx23_OF_ManipulationError_INS_14 = false;
	FIRE_xx24_OF_ManipulationError = false;
	FIRE_xx10_OF_Memory = false;
	FIRE_xx11_OF_Memory = false;
	FIRE_xx10_OF_PowerSupply = false;
	FIRE_xx11_OF_PowerSupply = false;
	FIRE_xx10_OF_Windows = false;
	FIRE_xx11_OF_Windows = false;

}

void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::fireOccurrence(int numFire)
{
	...
	if (numFire == 10)
	{
		FIRE_xx11_OF_FloppyDriveInUse = true;
	}
	...
	if (numFire == 12)
	{
		FIRE_xx11_OF_HardDrive = true;
	}

	if (numFire == 13)
	{
		FIRE_xx23_OF_ManipulationError_INS_13 = true;
	}

	if (numFire == 14)
	{
		FIRE_xx23_OF_ManipulationError_INS_14 = true;
	}

	if (numFire == 15)
	{
		FIRE_xx24_OF_ManipulationError = true;
	}
	...
	if (numFire == 21)
	{
		FIRE_xx11_OF_Windows = true;
	}

/* ---------- DECLARATION OF OCCURRENCE RULES------------ */

	// Occurrence xx17_OF_Cpu
	if ((boolState[failF_OF_Cpu] == false) && ((boolState[required_OF_Cpu] &&  boolState[relevant_evt_OF_Cpu]) && ( !boolState[failS_OF_Cpu]))) 
	{
	...
	if ((boolState[failS_OF_Cpu] == false) && ((( !boolState[required_OF_Cpu]) &&  boolState[relevant_evt_OF_Cpu]) && ( !boolState[failF_OF_Cpu]))) 
	{
...
&& boolState[relevant_evt_OF_DisplayUnit])) 
	{
	...
	// Occurrence xx11_OF_DisplayUnit
	if (boolState[failF_OF_DisplayUnit] == true) 
	{
		 
		if (FIRE_xx11_OF_DisplayUnit)
		{
			boolState[failF_OF_DisplayUnit]  =  false;
			FIRE_xx11_OF_DisplayUnit = false;
		}
	...
	if ((boolState[failF_OF_Fan] == false) && (boolState[required_OF_Fan] && boolState[relevant_evt_OF_Fan])) 
	{
...
&& boolState[relevant_evt_OF_FloppyDrive])) 
	{
	...
	// Occurrence xx11_OF_FloppyDrive
	if (boolState[failF_OF_FloppyDrive] == true) 
	{
		 
		if (FIRE_xx11_OF_FloppyDrive)
		{
			boolState[failF_OF_FloppyDrive]  =  false;
			FIRE_xx11_OF_FloppyDrive = false;
		}
	...
	if ((boolState[failF_OF_FloppyDriveInUse] == false) && (boolState[required_OF_FloppyDriveInUse] && boolState[relevant_evt_OF_FloppyDriveInUse])) 
	{
	...
	// Occurrence xx11_OF_FloppyDriveInUse
	if (boolState[failF_OF_FloppyDriveInUse] == true) 
	{
		 
		if (FIRE_xx11_OF_FloppyDriveInUse)
		{
			boolState[failF_OF_FloppyDriveInUse]  =  false;
			FIRE_xx11_OF_FloppyDriveInUse = false;
		}
	...
	if ((boolState[failF_OF_HardDrive] == false) && (boolState[required_OF_HardDrive] &&  boolState[relevant_evt_OF_HardDrive])) 
	{
	...
	// Occurrence xx11_OF_HardDrive
	if (boolState[failF_OF_HardDrive] == true) 
	{
		 
		if (FIRE_xx11_OF_HardDrive)
		{
			boolState[failF_OF_HardDrive]  =  false;
			FIRE_xx11_OF_HardDrive = false;
		}
	...
	if ((boolState[failI_OF_ManipulationError] == false) && (boolState[to_be_fired_OF_ManipulationError] && boolState[relevant_evt_OF_ManipulationError])) 
	{
	
		
		if (FIRE_xx23_OF_ManipulationError_INS_13) 
		{
	...
	if ((boolState[failI_OF_ManipulationError] == false) && (boolState[to_be_fired_OF_ManipulationError] && boolState[relevant_evt_OF_ManipulationError])) 
	{
		...
		if (FIRE_xx23_OF_ManipulationError_INS_14) 
		{
			boolState[already_standby_OF_ManipulationError]  =  false;
			boolState[already_required_OF_ManipulationError]  =  false;
			FIRE_xx23_OF_ManipulationError_INS_14 = false;
	...
	// Occurrence xx24_OF_ManipulationError
	if (boolState[failI_OF_ManipulationError] == true) 
	{
		 
		if (FIRE_xx24_OF_ManipulationError)
		{
			boolState[failI_OF_ManipulationError]  =  false;
			FIRE_xx24_OF_ManipulationError = false;
		}
	...
	if ((boolState[failF_OF_Memory] == false) && (boolState[required_OF_Memory] &&  boolState[relevant_evt_OF_Memory])) 
	{
	...
	// Occurrence xx11_OF_Memory
	if (boolState[failF_OF_Memory] == true) 
	{
		 
		if (FIRE_xx11_OF_Memory)
		{
			boolState[failF_OF_Memory]  =  false;
			FIRE_xx11_OF_Memory = false;
		}
...
&& boolState[relevant_evt_OF_PowerSupply])) 
	{
	...
	// Occurrence xx11_OF_PowerSupply
	if (boolState[failF_OF_PowerSupply] == true) 
	{
		 
		if (FIRE_xx11_OF_PowerSupply)
		{
			boolState[failF_OF_PowerSupply]  =  false;
			FIRE_xx11_OF_PowerSupply = false;
		}
	...
	if ((boolState[failF_OF_Windows] == false) && (boolState[required_OF_Windows] &&  boolState[relevant_evt_OF_Windows])) 
	{
	...
	// Occurrence xx11_OF_Windows
	if (boolState[failF_OF_Windows] == true) 
	{
		 
		if (FIRE_xx11_OF_Windows)
		{
			boolState[failF_OF_Windows]  =  false;
			FIRE_xx11_OF_Windows = false;
		}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::showFireableOccurrences()
{
	...
	if ((boolState[failI_OF_ManipulationError] == false) && (boolState[to_be_fired_OF_ManipulationError] && boolState[relevant_evt_OF_ManipulationError]))
	{
		cout << "13 :  INS_SUB_COUNT (1) |FAULT | failI  LABEL \"instantaneous failure ManipulationError\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_ManipulationError]  =  TRUE,already_standby_OF_ManipulationError  =  FALSE,already_required_OF_ManipulationError  =  FALSE" << endl;
		list.push_back(make_tuple(13, 0.0001, "INS", 1));
	}
	if ((boolState[failI_OF_ManipulationError] == false) && (boolState[to_be_fired_OF_ManipulationError] && boolState[relevant_evt_OF_ManipulationError]))
	{
		cout << "14 :  INS_SUB_COUNT (1) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_ManipulationError]  =  FALSE,already_required_OF_ManipulationError  =  FALSE" << endl;
		list.push_back(make_tuple(14, 0.9999, "INS", 1));
	}
        if (list.size() > 0)
        {
	...
	if ((boolState[failS_OF_Cpu] == true) || (boolState[failF_OF_Cpu] == true))
	{
		cout << "2 : xx19_OF_Cpu : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failS_OF_Cpu]  =  FALSE,failF_OF_Cpu  =  FALSE" << endl;
		list.push_back(make_tuple(2, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_DisplayUnit] == false) && (boolState[required_OF_DisplayUnit] && boolState[relevant_evt_OF_DisplayUnit]))
	{
		cout << "3 : xx10_OF_DisplayUnit : FAULT failF  LABEL \"failure in operation DisplayUnit\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_DisplayUnit]  =  TRUE" << endl;
		list.push_back(make_tuple(3, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_DisplayUnit] == true)
	{
		cout << "4 : xx11_OF_DisplayUnit : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_DisplayUnit]  =  FALSE" << endl;
		list.push_back(make_tuple(4, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_Fan] == false) && (boolState[required_OF_Fan] && boolState[relevant_evt_OF_Fan]))
	{
		cout << "5 : xx10_OF_Fan : FAULT failF  LABEL \"failure in operation Fan\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Fan]  =  TRUE" << endl;
		list.push_back(make_tuple(5, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_Fan] == true)
	{
		cout << "6 : xx11_OF_Fan : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_Fan]  =  FALSE" << endl;
		list.push_back(make_tuple(6, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_FloppyDrive] == false) && (boolState[required_OF_FloppyDrive] && boolState[relevant_evt_OF_FloppyDrive]))
	{
		cout << "7 : xx10_OF_FloppyDrive : FAULT failF  LABEL \"failure in operation FloppyDrive\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_FloppyDrive]  =  TRUE" << endl;
		list.push_back(make_tuple(7, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_FloppyDrive] == true)
	{
		cout << "8 : xx11_OF_FloppyDrive : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_FloppyDrive]  =  FALSE" << endl;
		list.push_back(make_tuple(8, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_FloppyDriveInUse] == false) && (boolState[required_OF_FloppyDriveInUse] && boolState[relevant_evt_OF_FloppyDriveInUse]))
	{
		cout << "9 : xx10_OF_FloppyDriveInUse : FAULT failF  LABEL \"failure in operation FloppyDriveInUse\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_FloppyDriveInUse]  =  TRUE" << endl;
		list.push_back(make_tuple(9, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_FloppyDriveInUse] == true)
	{
		cout << "10 : xx11_OF_FloppyDriveInUse : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_FloppyDriveInUse]  =  FALSE" << endl;
		list.push_back(make_tuple(10, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_HardDrive] == false) && (boolState[required_OF_HardDrive] && boolState[relevant_evt_OF_HardDrive]))
	{
		cout << "11 : xx10_OF_HardDrive : FAULT failF  LABEL \"failure in operation HardDrive\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_HardDrive]  =  TRUE" << endl;
		list.push_back(make_tuple(11, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_HardDrive] == true)
	{
		cout << "12 : xx11_OF_HardDrive : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_HardDrive]  =  FALSE" << endl;
		list.push_back(make_tuple(12, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_ManipulationError] == true)
	{
		cout << "15 : xx24_OF_ManipulationError : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_ManipulationError]  =  FALSE" << endl;
		list.push_back(make_tuple(15, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_Memory] == false) && (boolState[required_OF_Memory] && boolState[relevant_evt_OF_Memory]))
	{
		cout << "16 : xx10_OF_Memory : FAULT failF  LABEL \"failure in operation Memory\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Memory]  =  TRUE" << endl;
		list.push_back(make_tuple(16, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_Memory] == true)
	{
		cout << "17 : xx11_OF_Memory : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_Memory]  =  FALSE" << endl;
		list.push_back(make_tuple(17, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_PowerSupply] == false) && (boolState[required_OF_PowerSupply] && boolState[relevant_evt_OF_PowerSupply]))
	{
		cout << "18 : xx10_OF_PowerSupply : FAULT failF  LABEL \"failure in operation PowerSupply\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_PowerSupply]  =  TRUE" << endl;
		list.push_back(make_tuple(18, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_PowerSupply] == true)
	{
		cout << "19 : xx11_OF_PowerSupply : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_PowerSupply]  =  FALSE" << endl;
		list.push_back(make_tuple(19, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_Windows] == false) && (boolState[required_OF_Windows] && boolState[relevant_evt_OF_Windows]))
	{
		cout << "20 : xx10_OF_Windows : FAULT failF  LABEL \"failure in operation Windows\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Windows]  =  TRUE" << endl;
		list.push_back(make_tuple(20, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_Windows] == true)
	{
		cout << "21 : xx11_OF_Windows : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_Windows]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::runOnceInteractionStep_initialization()
{
	if ((boolState[failS_OF_Cpu] == true) || (boolState[failF_OF_Cpu] == true) )
	{
...
void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_AND_1] && ( !boolState[S_OF_AND_1])) || ( !boolState[S_OF_OR_1]) )
	{
...
void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_08_PC_Trim_Article_repair::fireinsttransitiongroup(std::string user_input_ins)
