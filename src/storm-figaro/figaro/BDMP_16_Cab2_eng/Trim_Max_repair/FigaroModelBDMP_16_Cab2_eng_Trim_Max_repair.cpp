#include <iostream>
#include "FigaroModelBDMP_16_Cab2_eng_Trim_Max_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::init()
{
...
void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::figaromodelhasinstransitions()
{
	return false;
}
void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::fireOccurrence(int numFire)
{
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::showFireableOccurrences()
{
...
void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_C1] == true )
	{
...
void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::runOnceInteractionStep_propagate_leaves()
{
...
void
storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_16_Cab2_eng_Trim_Max_repair::fireinsttransitiongroup(std::string user_input_ins)
