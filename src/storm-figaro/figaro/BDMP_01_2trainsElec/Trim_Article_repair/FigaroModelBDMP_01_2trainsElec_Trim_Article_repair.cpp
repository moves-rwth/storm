#include <iostream>
#include "FigaroModelBDMP_01_2trainsElec_Trim_Article_repair.h"
...
void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::init()
{
	...
	FIRE_xx11_OF_CB1_IO = false;
	FIRE_xx23_OF_CB1_RO_INS_2 = false;
	FIRE_xx23_OF_CB1_RO_INS_3 = false;
	FIRE_xx24_OF_CB1_RO = false;
	FIRE_xx23_OF_CB2_RC_INS_5 = false;
	FIRE_xx23_OF_CB2_RC_INS_6 = false;
	FIRE_xx24_OF_CB2_RC = false;
	FIRE_xx10_OF_Dies_gen = false;
	FIRE_xx11_OF_Dies_gen = false;
	FIRE_xx23_OF_Dies_gen_RS_INS_10 = false;
	FIRE_xx23_OF_Dies_gen_RS_INS_11 = false;
	FIRE_xx24_OF_Dies_gen_RS = false;
	FIRE_xx10_OF_Grid = false;
	FIRE_xx11_OF_Grid = false;

}

void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::saveCurrentState()
{
...
int storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::compareStates()
{
...
void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::printState()
{
...
bool storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::figaromodelhasinstransitions()
{
	return true;
}
void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::doReinitialisations()
{
...
void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::fireOccurrence(int numFire)
{
	...
	if (numFire == 3)
	{
		FIRE_xx23_OF_CB1_RO_INS_3 = true;
	}

	if (numFire == 4)
	{
		FIRE_xx24_OF_CB1_RO = true;
	}

	if (numFire == 5)
	{
		FIRE_xx23_OF_CB2_RC_INS_5 = true;
	}

	if (numFire == 6)
	{
		FIRE_xx23_OF_CB2_RC_INS_6 = true;
	}

	if (numFire == 7)
	{
		FIRE_xx24_OF_CB2_RC = true;
	}
	...
	if (numFire == 9)
	{
		FIRE_xx11_OF_Dies_gen = true;
	}

	if (numFire == 10)
	{
		FIRE_xx23_OF_Dies_gen_RS_INS_10 = true;
	}

	if (numFire == 11)
	{
		FIRE_xx23_OF_Dies_gen_RS_INS_11 = true;
	}

	if (numFire == 12)
	{
		FIRE_xx24_OF_Dies_gen_RS = true;
	}
...
/* ---------- DECLARATION OF OCCURRENCE RULES------------ */
	...
	if ((boolState[failF_OF_CB1_IO] == false) && (boolState[required_OF_CB1_IO] &&  boolState[relevant_evt_OF_CB1_IO])) 
	{
	...
	// Occurrence xx11_OF_CB1_IO
	if (boolState[failF_OF_CB1_IO] == true) 
	{
		 
		if (FIRE_xx11_OF_CB1_IO)
		{
			boolState[failF_OF_CB1_IO]  =  false;
			FIRE_xx11_OF_CB1_IO = false;
		}
	...
	boolState[relevant_evt_OF_CB1_RO])) 
	{
	...
	// Occurrence xx24_OF_CB1_RO
	if (boolState[failI_OF_CB1_RO] == true) 
	{
		 
		if (FIRE_xx24_OF_CB1_RO)
		{
			boolState[failI_OF_CB1_RO]  =  false;
			FIRE_xx24_OF_CB1_RO = false;
		}
	...
	boolState[relevant_evt_OF_CB2_RC])) 
	{
	
		
		if (FIRE_xx23_OF_CB2_RC_INS_5) 
		{
	...
	// Occurrence xx24_OF_CB2_RC
	if (boolState[failI_OF_CB2_RC] == true) 
	{
		 
		if (FIRE_xx24_OF_CB2_RC)
		{
			boolState[failI_OF_CB2_RC]  =  false;
			FIRE_xx24_OF_CB2_RC = false;
		}
	...
	if ((boolState[failF_OF_Dies_gen] == false) && (boolState[required_OF_Dies_gen] &&  boolState[relevant_evt_OF_Dies_gen])) 
	{
	...
	// Occurrence xx11_OF_Dies_gen
	if (boolState[failF_OF_Dies_gen] == true) 
	{
		 
		if (FIRE_xx11_OF_Dies_gen)
		{
			boolState[failF_OF_Dies_gen]  =  false;
			FIRE_xx11_OF_Dies_gen = false;
		}
	...
	if ((boolState[failI_OF_Dies_gen_RS] == false) && (boolState[to_be_fired_OF_Dies_gen_RS] && boolState[relevant_evt_OF_Dies_gen_RS])) 
	{
	
		
		if (FIRE_xx23_OF_Dies_gen_RS_INS_10) 
		{
	...
	if ((boolState[failI_OF_Dies_gen_RS] == false) && (boolState[to_be_fired_OF_Dies_gen_RS] && boolState[relevant_evt_OF_Dies_gen_RS])) 
	{
		...
		if (FIRE_xx23_OF_Dies_gen_RS_INS_11) 
		{
			boolState[already_standby_OF_Dies_gen_RS]  =  false;
			boolState[already_required_OF_Dies_gen_RS]  =  false;
			FIRE_xx23_OF_Dies_gen_RS_INS_11 = false;
	...
	// Occurrence xx24_OF_Dies_gen_RS
	if (boolState[failI_OF_Dies_gen_RS] == true) 
	{
		 
		if (FIRE_xx24_OF_Dies_gen_RS)
		{
			boolState[failI_OF_Dies_gen_RS]  =  false;
			FIRE_xx24_OF_Dies_gen_RS = false;
		}
...
std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::showFireableOccurrences()
{
	std::vector<std::tuple<int, double, std::string, int>> list = {};
	cout <<"\n==================== List of fireable occurrences :  ====================" << endl;

	if ((boolState[failI_OF_CB1_RO] == false) && (boolState[to_be_fired_OF_CB1_RO] &&	boolState[relevant_evt_OF_CB1_RO]))
	{
		cout << "2 :  INS_SUB_COUNT (1) |FAULT | failI  LABEL \"instantaneous failure CB1_RO\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_CB1_RO]  =  TRUE,already_standby_OF_CB1_RO  =  FALSE,already_required_OF_CB1_RO  =  FALSE" << endl;
		list.push_back(make_tuple(2, 0.0001, "INS", 1));
	}
	if ((boolState[failI_OF_CB1_RO] == false) && (boolState[to_be_fired_OF_CB1_RO] &&	boolState[relevant_evt_OF_CB1_RO]))
	{
		cout << "3 :  INS_SUB_COUNT (1) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_CB1_RO]  =  FALSE,already_required_OF_CB1_RO  =  FALSE" << endl;
		list.push_back(make_tuple(3, 0.9999, "INS", 1));
	}
	if ((boolState[failI_OF_CB2_RC] == false) && (boolState[to_be_fired_OF_CB2_RC] &&	boolState[relevant_evt_OF_CB2_RC]))
	{
		cout << "5 :  INS_SUB_COUNT (2) |FAULT | failI  LABEL \"instantaneous failure CB2_RC\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_CB2_RC]  =  TRUE,already_standby_OF_CB2_RC  =  FALSE,already_required_OF_CB2_RC  =  FALSE" << endl;
		list.push_back(make_tuple(5, 0.0001, "INS", 2));
	}
	if ((boolState[failI_OF_CB2_RC] == false) && (boolState[to_be_fired_OF_CB2_RC] &&	boolState[relevant_evt_OF_CB2_RC]))
	{
		cout << "6 :  INS_SUB_COUNT (2) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_CB2_RC]  =  FALSE,already_required_OF_CB2_RC  =  FALSE" << endl;
		list.push_back(make_tuple(6, 0.9999, "INS", 2));
	}
	if ((boolState[failI_OF_Dies_gen_RS] == false) && (boolState[to_be_fired_OF_Dies_gen_RS] && boolState[relevant_evt_OF_Dies_gen_RS]))
	{
		cout << "10 :  INS_SUB_COUNT (3) |FAULT | failI  LABEL \"instantaneous failure Dies_gen_RS\" | DIST INS (0.0001) | INDUCING boolState[failI_OF_Dies_gen_RS]  =  TRUE,already_standby_OF_Dies_gen_RS  =  FALSE,already_required_OF_Dies_gen_RS  =  FALSE" << endl;
		list.push_back(make_tuple(10, 0.0001, "INS", 3));
	}
	if ((boolState[failI_OF_Dies_gen_RS] == false) && (boolState[to_be_fired_OF_Dies_gen_RS] && boolState[relevant_evt_OF_Dies_gen_RS]))
	{
		cout << "11 :  INS_SUB_COUNT (3) |TRANSITION | good | DIST INS (0.9999) | INDUCING boolState[already_standby_OF_Dies_gen_RS]  =  FALSE,already_required_OF_Dies_gen_RS  =  FALSE" << endl;
	...
	if (boolState[failF_OF_CB1_IO] == true)
	{
		cout << "1 : xx11_OF_CB1_IO : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_CB1_IO]  =  FALSE" << endl;
		list.push_back(make_tuple(1, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_CB1_RO] == true)
	{
		cout << "4 : xx24_OF_CB1_RO : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_CB1_RO]  =  FALSE" << endl;
		list.push_back(make_tuple(4, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_CB2_RC] == true)
	{
		cout << "7 : xx24_OF_CB2_RC : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_CB2_RC]  =  FALSE" << endl;
		list.push_back(make_tuple(7, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_Dies_gen] == false) && (boolState[required_OF_Dies_gen] && boolState[relevant_evt_OF_Dies_gen]))
	{
		cout << "8 : xx10_OF_Dies_gen : FAULT failF  LABEL \"failure in operation Dies_gen\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Dies_gen]  =  TRUE" << endl;
		list.push_back(make_tuple(8, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_Dies_gen] == true)
	{
		cout << "9 : xx11_OF_Dies_gen : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_Dies_gen]  =  FALSE" << endl;
		list.push_back(make_tuple(9, 0.1, "EXP", 0));
	}
	if (boolState[failI_OF_Dies_gen_RS] == true)
	{
		cout << "12 : xx24_OF_Dies_gen_RS : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failI_OF_Dies_gen_RS]  =  FALSE" << endl;
		list.push_back(make_tuple(12, 0.1, "EXP", 0));
	}
	if ((boolState[failF_OF_Grid] == false) && (boolState[required_OF_Grid] && boolState[relevant_evt_OF_Grid]))
	{
		cout << "13 : xx10_OF_Grid : FAULT failF  LABEL \"failure in operation Grid\"  DIST EXP (0.0001)  INDUCING boolState[failF_OF_Grid]  =  TRUE" << endl;
		list.push_back(make_tuple(13, 0.0001, "EXP", 0));
	}
	if (boolState[failF_OF_Grid] == true)
	{
		cout << "14 : xx11_OF_Grid : REPAIR rep  DIST EXP (0.1)  INDUCING boolState[failF_OF_Grid]  =  FALSE" << endl;
...
void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::runOnceInteractionStep_initialization()
{
	if (boolState[failF_OF_CB1_IO] == true )
	{
...
void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::runOnceInteractionStep_propagate_effect_required()
{
	...
	if ((boolState[relevant_evt_OF_LossOfLine_1] && ( !boolState[S_OF_LossOfLine_1])) || ( !boolState[S_OF_CB1_RO]) )
	{
	...
	if ((boolState[relevant_evt_OF_AND_1] && ( !boolState[S_OF_AND_1])) || ( !boolState[S_OF_LossOfDieselLine]) )
	{
...
void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::runOnceInteractionStep_tops()
{
...
void
storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::runInteractions() {
    int counter = 0;
        int comparator = 1;
        doReinitialisations();
	...
	boolFailureState[exp0] = ( boolState[S_OF_UE_1] );
        cout << endl;
    }void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::printstatetuple(){
        ...
        int_fast64_t storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::stateSize() const{
            return numBoolState;
}
        void storm::figaro::FigaroProgram_BDMP_01_2trainsElec_Trim_Article_repair::fireinsttransitiongroup(std::string user_input_ins)
