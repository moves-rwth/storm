...
void storm::figaro::FigaroProgram2::init()
{
...
boolFailureState[0] = boolState[S_OF_UE_1];
}

void storm::figaro::FigaroProgram2::saveCurrentState()
{
...
int storm::figaro::FigaroProgram2::compareStates()
{
...
void storm::figaro::FigaroProgram2::printState()
{
...
bool storm::figaro::FigaroProgram2::figaromodelhasinstransitions()
{
	return true;
}

void storm::figaro::FigaroProgram2::doReinitialisations()
{
...
void storm::figaro::FigaroProgram2::fireOccurrence(int numFire)
{
...
&& boolState[relevant_evt_OF_SUBSTATION])) 
    ...
    boolFailureState[0] = intState[S_OF_UE_1];
    std::cout<<"interaction f ired\n";
}

std::vector<std::tuple<int, double, std::string, int>> storm::figaro::FigaroProgram2::showFireableOccurrences()
{
	std::vector<std::tuple<int, double, std::string, int>> list = {};
	cout <<"\n==================== List of fireable occurrences :  ====================" << endl;

	if ((boolState[failI_OF_RC_CB_LGD2] == false) && (to_be_fired_OF_RC_CB_LGD2	&& boolState[relevant_evt_OF_RC_CB_LGD2]))
	{
	...
	if ((boolState[failI_OF_RC_CB_LGF2] == false) && (to_be_fired_OF_RC_CB_LGF2	&& boolState[relevant_evt_OF_RC_CB_LGF2]))
	{
	...
	if ((boolState[failI_OF_demand_TAC] == false) && (to_be_fired_OF_demand_TAC	&& boolState[relevant_evt_OF_demand_TAC]))
	{
...
void storm::figaro::FigaroProgram2::runOnceInteractionStep_check_priorities()
{
...
void storm::figaro::FigaroProgram2::runOnceInteractionStep_initialization()
{
...
void storm::figaro::FigaroProgram2::runOnceInteractionStep_propagate_effect_S()
{
...
void storm::figaro::FigaroProgram2::runOnceInteractionStep_propagate_effect_required()
{
...
void storm::figaro::FigaroProgram2::runOnceInteractionStep_propagate_leaves()
{
...
void storm::figaro::FigaroProgram2::runOnceInteractionStep_tops()
{
...
void storm::figaro::FigaroProgram2::runInteractions() {
    int counter = 0;
    int comparator = 1;
    doReinitialisations();
	...
	do
 	...
 	cout << endl;
        ...
        void storm::figaro::FigaroProgram2::printstatetuple(){
            std::cout<<"\n State information: (";
        ...
        int_fast64_t FigaroProgram2::stateSize() const{
            return numBoolState;
        }
        
        void storm::figaro::FigaroProgram2::fireinsttransitiongroup(std::string user_input_ins)
        {
        ...
        void storm::figaro::FigaroProgram2::runOnceInteractionStep_default_step() {
        }
