...
#else
            throw storm::exceptions::NotImplementedException() << "This version of Storm was compiled without support for CUDD. Yet, a method was called that "
                                                                  "requires this support. Please choose a version of Storm with CUDD support.";
#endif
            break;
...
#else
            throw storm::exceptions::NotImplementedException() << "This version of Storm was compiled without support for Sylvan. Yet, a method was called "
                                                                  "that requires this support. Please choose a version of Storm with Sylvan support.";
#endif
                break;
                default:
