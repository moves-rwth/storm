...
template<>
void Scheduler<float>::printJsonToStream([[maybe_unused]] std::ostream& out, [[maybe_unused]] std::shared_ptr<storm::models::sparse::Model<float>> model,
                                         [[maybe_unused]] bool skipUniqueChoices, [[maybe_unused]] bool skipDontCareStates) const {
