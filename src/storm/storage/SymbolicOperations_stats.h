...
static storm::dd::Bdd<Type> post_stats(storm::dd::Bdd<Type> const &statesToApplyPostOn, storm::dd::Bdd<Type> const &allStates,
...
template<storm::dd::DdType Type>
static storm::dd::Bdd<Type> pre_stats(storm::dd::Bdd<Type> const &statesToApplyPreOn, storm::dd::Bdd<Type> const &allStates,
                                      storm::dd::Bdd<Type> const &transitions, std::set<storm::expressions::Variable> const &metaVariablesRow,
                                      std::set<storm::expressions::Variable> const &metaVariablesColumn, uint_fast64_t &countSymbolicOps) {
