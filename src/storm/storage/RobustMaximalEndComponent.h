 ...
 */
class RobustMaximalEndComponent {
   public:
    typedef storm::storage::FlatSet<std::vector<sparse::state_type>> set_type;
     ...
     */
    RobustMaximalEndComponent(RobustMaximalEndComponent const& other);
     ...
     */
    RobustMaximalEndComponent& operator=(RobustMaximalEndComponent const& other);
     ...
     */
    RobustMaximalEndComponent(RobustMaximalEndComponent&& other);
     ...
     */
    RobustMaximalEndComponent& operator=(RobustMaximalEndComponent&& other);

    /*!
     * @return true iff this is the same MEC as other
     */
    bool operator==(RobustMaximalEndComponent const& other);
     ...
     */
    bool containsChoice(uint_fast64_t state, std::vector<uint_fast64_t> choice) const;
     ...
     */
    storm::storage::FlatSet<sparse::state_type> getStateSet() const;
    ...
    friend std::ostream& operator<<(std::ostream& out, RobustMaximalEndComponent const& component);
