...
template<typename ValueType>
typename std::enable_if<std::is_same<ValueType, storm::RationalFunction>::value, std::unique_ptr<storm::modelchecker::CheckResult>>::type
verifyWithSparseEngine([[maybe_unused]] storm::Environment const& env, [[maybe_unused]] std::shared_ptr<storm::models::sparse::Smg<ValueType>> const& mdp,
                       [[maybe_unused]] storm::modelchecker::CheckTask<storm::logic::Formula, ValueType> const& task) {
