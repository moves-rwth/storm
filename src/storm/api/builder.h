...
inline std::shared_ptr<storm::models::symbolic::Model<storm::dd::DdType::CUDD, storm::RationalNumber>> buildSymbolicModel(
    [[maybe_unused]] storm::storage::SymbolicModelDescription const& model,
    [[maybe_unused]] std::vector<std::shared_ptr<storm::logic::Formula const>> const& formulas, bool, bool) {
...
template<typename ValueType>
std::shared_ptr<storm::models::sparse::Model<ValueType>> buildExplicitModel(
    [[maybe_unused]] std::string const& transitionsFile, [[maybe_unused]] std::string const& labelingFile,
