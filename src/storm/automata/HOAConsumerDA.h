...
namespace storm {
    namespace automata {
        ...
        public:
             ...
             */
            virtual void addState(unsigned int id, [[maybe_unused]] std::shared_ptr<std::string> info, label_expr::ptr labelExpr, std::shared_ptr<int_list> accSignature) {
                if (accSignature) {
             ...
             * has ended [multiple].
             */
            virtual void notifyEndOfState([[maybe_unused]] unsigned int stateId) {
                helper->endOfState();
            }
