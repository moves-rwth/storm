...
namespace storm {
    namespace settings {
        namespace modules {
            ...
            const std::string JaniExportSettings::reduceStateSpaceOptionName = "reduce-state-space";
            ...
            JaniExportSettings::JaniExportSettings() : ModuleSettings(moduleName) {
                ...
                this->addOption(storm::settings::OptionBuilder(moduleName, reduceStateSpaceOptionName, false, "If set, attempts to perform local elimination of states to reduce the state space of the final model.").build());
            }
            ...
            bool JaniExportSettings::isReduceStateSpaceSet() const {
                return this->getOption(reduceStateSpaceOptionName).getHasOptionBeenSet();
            }
