...
namespace storm {
    namespace transformations {
        namespace dft {
            ...
            template<typename ParametricType, typename ConstantType>
            std::vector<std::string> DftInstantiator<ParametricType, ConstantType>::getChildrenVector(std::shared_ptr<storm::storage::DFTElement<ParametricType> const> element) {
