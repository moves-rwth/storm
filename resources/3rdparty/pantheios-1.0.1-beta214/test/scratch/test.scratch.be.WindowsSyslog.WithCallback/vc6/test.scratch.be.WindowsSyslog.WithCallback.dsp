# Microsoft Developer Studio Project File - Name="test.scratch.be.WindowsSyslog.WithCallback" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug Multithreaded DLL
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.scratch.be.WindowsSyslog.WithCallback.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.scratch.be.WindowsSyslog.WithCallback.mak" CFG="test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug Multithreaded DLL"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.scratch.be.WindowsSyslog.WithCallback - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.WindowsSyslog.WithCallback - Win32 Release Multithreaded" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug Multithreaded" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.WindowsSyslog.WithCallback - Win32 Release Multithreaded DLL" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug Multithreaded DLL" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.scratch.be.WindowsSyslog.WithCallback - Win32 Release"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ELSEIF  "$(CFG)" == "test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.debug.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ELSEIF  "$(CFG)" == "test.scratch.be.WindowsSyslog.WithCallback - Win32 Release Multithreaded"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.mt.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.mt.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.mt.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ELSEIF  "$(CFG)" == "test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug Multithreaded"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.mt.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.mt.debug.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.mt.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ELSEIF  "$(CFG)" == "test.scratch.be.WindowsSyslog.WithCallback - Win32 Release Multithreaded DLL"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.dll.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.dll.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.dll.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ELSEIF  "$(CFG)" == "test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug Multithreaded DLL"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.dll.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib"
# ADD LINK32 libWinSysLog.vc6.dll.debug.lib pthreadVC.lib kernel32.lib advapi32.lib ole32.lib oleaut32.lib ws2_32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.scratch.be.WindowsSyslog.WithCallback.vc6.dll.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(SHWILD_ROOT)/lib" /libpath:"$(SYNESIS_DEV)/lib" /libpath:"$(PTHREADS_WIN32)/lib"

!ENDIF

# Begin Target

# Name "test.scratch.be.WindowsSyslog.WithCallback - Win32 Release"
# Name "test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug"
# Name "test.scratch.be.WindowsSyslog.WithCallback - Win32 Release Multithreaded"
# Name "test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug Multithreaded"
# Name "test.scratch.be.WindowsSyslog.WithCallback - Win32 Release Multithreaded DLL"
# Name "test.scratch.be.WindowsSyslog.WithCallback - Win32 Debug Multithreaded DLL"
...
SOURCE=..\test.scratch.be.WindowsSyslog.WithCallback.cpp
# End Source File
# End Group
...
SOURCE="$(PANTHEIOS_ROOT)\include\pantheios\implicit_link\be.WindowsSyslog.WithCallback.h"
# End Source File
# Begin Source File
...
SOURCE="$(PANTHEIOS_ROOT)\include\pantheios\implicit_link\bec.WindowsSyslog.WithCallback.h"
# End Source File
# Begin Source File
