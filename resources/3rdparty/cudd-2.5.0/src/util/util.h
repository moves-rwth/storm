...
#if (defined(__STDC__) || defined(__cplusplus) || defined(ultrix)) && !defined(MNEMOSYNE) || defined(__SVR4) || defined(WIN32)
#	include <stdlib.h>
#else
#	ifndef _IBMR2
...
#if defined(__STDC__) || defined(__cplusplus) || defined(_IBMR2) || defined(ultrix) || defined(WIN32)
#include <string.h>
#else
