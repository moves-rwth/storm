...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_INDEX_LIST_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_INDEX_LIST_H

#if defined(STORMEIGEN_HAS_CONSTEXPR) && defined(STORMEIGEN_HAS_VARIADIC_TEMPLATES)

#define STORMEIGEN_HAS_INDEX_LIST
...
template<typename FirstType, typename... OtherTypes>
  ...
  STORMEIGEN_STRONG_INLINE STORMEIGEN_DEVICE_FUNC constexpr DenseIndex operator[] (const DenseIndex i) const {
    return internal::tuple_coeff<internal::array_size<internal::IndexTuple<FirstType, OtherTypes...> >::value-1>::get(i, *this);
  }
  STORMEIGEN_STRONG_INLINE STORMEIGEN_DEVICE_FUNC constexpr DenseIndex get(const DenseIndex i) const {
    return internal::tuple_coeff<internal::array_size<internal::IndexTuple<FirstType, OtherTypes...> >::value-1>::get(i, *this);
  }
  STORMEIGEN_STRONG_INLINE STORMEIGEN_DEVICE_FUNC void set(const DenseIndex i, const DenseIndex value) {
...
struct index_statically_eq_impl {
  STORMEIGEN_DEVICE_FUNC static constexpr bool run(DenseIndex, DenseIndex) {
    return false;
  }
};
...
struct index_statically_eq_impl<IndexList<FirstType, OtherTypes...> > {
  STORMEIGEN_DEVICE_FUNC static constexpr bool run(const DenseIndex i, const DenseIndex value) {
    return IndexList<FirstType, OtherTypes...>().value_known_statically(i) &
...
template <typename T>
struct index_known_statically_impl {
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE static bool run(const DenseIndex) {
    return false;
  }
};
...
template <typename T>
struct all_indices_known_statically_impl {
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE static bool run() {
    return false;
  }
};
...
template <typename T>
struct index_statically_eq_impl {
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE static bool run(DenseIndex, DenseIndex) {
    return false;
  }
};
...
namespace internal {
template <typename T>
static STORMEIGEN_DEVICE_FUNC STORMEIGEN_CONSTEXPR bool index_known_statically(DenseIndex i) {
  return index_known_statically_impl<T>::run(i);
}

template <typename T>
static STORMEIGEN_DEVICE_FUNC STORMEIGEN_CONSTEXPR bool all_indices_known_statically() {
  return all_indices_known_statically_impl<T>::run();
}

template <typename T>
static STORMEIGEN_DEVICE_FUNC STORMEIGEN_CONSTEXPR bool indices_statically_known_to_increase() {
  return indices_statically_known_to_increase_impl<T>::run();
}

template <typename T>
static STORMEIGEN_DEVICE_FUNC STORMEIGEN_CONSTEXPR bool index_statically_eq(DenseIndex i, DenseIndex value) {
  return index_statically_eq_impl<T>::run(i, value);
}

template <typename T>
static STORMEIGEN_DEVICE_FUNC STORMEIGEN_CONSTEXPR bool index_statically_ne(DenseIndex i, DenseIndex value) {
  return index_statically_ne_impl<T>::run(i, value);
}

template <typename T>
static STORMEIGEN_DEVICE_FUNC STORMEIGEN_CONSTEXPR bool index_statically_gt(DenseIndex i, DenseIndex value) {
  return index_statically_gt_impl<T>::run(i, value);
}

template <typename T>
static STORMEIGEN_DEVICE_FUNC STORMEIGEN_CONSTEXPR bool index_statically_lt(DenseIndex i, DenseIndex value) {
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_INDEX_LIST_H
