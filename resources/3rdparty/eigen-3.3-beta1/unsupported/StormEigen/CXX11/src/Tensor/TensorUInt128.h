...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_UINT128_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_UINT128_H
...
struct static_val {
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE operator uint64_t() const { return n; }

  STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE static_val() { }
  template <typename T>
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE static_val(const T& v) {
    eigen_assert(v == n);
  }
};
...
struct TensorUInt128
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE operator LOW() const {
    return low;
  }
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE LOW lower() const {
    return low;
  }
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE HIGH upper() const {
    return high;
  }
};
...
#endif  // STORMEIGEN_CXX11_TENSOR_TENSOR_UINT128_H
