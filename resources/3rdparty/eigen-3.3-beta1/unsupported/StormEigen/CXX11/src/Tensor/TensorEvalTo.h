...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_EVAL_TO_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_EVAL_TO_H
...
class TensorEvalToOp : public TensorBase<TensorEvalToOp<XprType> >
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorEvalToOp(CoeffReturnType* buffer, const XprType& expr)
    ...
    STORMEIGEN_DEVICE_FUNC CoeffReturnType* buffer() const { return m_buffer; }
...
struct TensorEvaluator<const TensorEvalToOp<ArgType>, Device>
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE ~TensorEvaluator() {
  }
  ...
  STORMEIGEN_DEVICE_FUNC const Dimensions& dimensions() const { return m_impl.dimensions(); }

  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE bool evalSubExprsIfNeeded(CoeffReturnType* scalar) {
    eigen_assert(scalar == NULL);
    return m_impl.evalSubExprsIfNeeded(m_buffer);
  }

  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE void evalScalar(Index i) {
    m_buffer[i] = m_impl.coeff(i);
  }
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE void evalPacket(Index i) {
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_EVAL_TO_H
