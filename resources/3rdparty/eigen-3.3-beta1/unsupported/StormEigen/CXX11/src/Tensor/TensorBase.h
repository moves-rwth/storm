...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_BASE_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_BASE_H
...
class TensorBase<Derived, ReadOnlyAccessors>
{
  public:
    ...
    STORMEIGEN_STRONG_INLINE const TensorCwiseNullaryOp<CustomNullaryOp, const Derived>
    ...
    STORMEIGEN_STRONG_INLINE const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived>
    constant(const Scalar& value) const {
      return nullaryExpr(internal::scalar_constant_op<Scalar>(value));
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseNullaryOp<internal::UniformRandomGenerator<Scalar>, const Derived>
    random() const {
      return nullaryExpr(internal::UniformRandomGenerator<Scalar>());
    }
    template <typename RandomGenerator> STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseNullaryOp<RandomGenerator, const Derived>
    random(const RandomGenerator& gen = RandomGenerator()) const {
      return nullaryExpr(gen);
    }

    // Tensor generation
    template <typename Generator> STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorGeneratorOp<Generator, const Derived>
    ...
    template <typename CustomUnaryOp> STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<CustomUnaryOp, const Derived>
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_opposite_op<Scalar>, const Derived>
    operator-() const {
      return unaryExpr(internal::scalar_opposite_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_sqrt_op<Scalar>, const Derived>
    sqrt() const {
      return unaryExpr(internal::scalar_sqrt_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_sign_op<Scalar>, const Derived>
    sign() const {
      return unaryExpr(internal::scalar_sign_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_rsqrt_op<Scalar>, const Derived>
    rsqrt() const {
      return unaryExpr(internal::scalar_rsqrt_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_square_op<Scalar>, const Derived>
    square() const {
      return unaryExpr(internal::scalar_square_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_cube_op<Scalar>, const Derived>
    cube() const {
      return unaryExpr(internal::scalar_cube_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_inverse_op<Scalar>, const Derived>
    inverse() const {
      return unaryExpr(internal::scalar_inverse_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_tanh_op<Scalar>, const Derived>
    tanh() const {
      return unaryExpr(internal::scalar_tanh_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_lgamma_op<Scalar>, const Derived>
    lgamma() const {
      return unaryExpr(internal::scalar_lgamma_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_erf_op<Scalar>, const Derived>
    erf() const {
      return unaryExpr(internal::scalar_erf_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_erfc_op<Scalar>, const Derived>
    erfc() const {
      return unaryExpr(internal::scalar_erfc_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_sigmoid_op<Scalar>, const Derived>
    sigmoid() const {
      return unaryExpr(internal::scalar_sigmoid_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_exp_op<Scalar>, const Derived>
    exp() const {
      return unaryExpr(internal::scalar_exp_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_log_op<Scalar>, const Derived>
    log() const {
      return unaryExpr(internal::scalar_log_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_abs_op<Scalar>, const Derived>
    abs() const {
      return unaryExpr(internal::scalar_abs_op<Scalar>());
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_pow_op<Scalar>, const Derived>
    pow(Scalar exponent) const {
      return unaryExpr(internal::scalar_pow_op<Scalar>(exponent));
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_add_op<Scalar>, const Derived>
    operator+ (Scalar rhs) const {
      return unaryExpr(internal::scalar_add_op<Scalar>(rhs));
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_sub_op<Scalar>, const Derived>
    operator- (Scalar rhs) const {
      STORMEIGEN_STATIC_ASSERT((NumTraits<Scalar>::IsSigned || internal::is_same<Scalar, const std::complex<float> >::value), YOU_MADE_A_PROGRAMMING_MISTAKE);
      return unaryExpr(internal::scalar_sub_op<Scalar>(rhs));
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_multiple_op<Scalar>, const Derived>
    operator* (Scalar rhs) const {
      return unaryExpr(internal::scalar_multiple_op<Scalar>(rhs));
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_quotient1_op<Scalar>, const Derived>
    operator/ (Scalar rhs) const {
      return unaryExpr(internal::scalar_quotient1_op<Scalar>(rhs));
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_mod_op<Scalar>, const Derived>
    operator% (Scalar rhs) const {
      STORMEIGEN_STATIC_ASSERT(NumTraits<Scalar>::IsInteger, YOU_MADE_A_PROGRAMMING_MISTAKE_TRY_MOD);
      return unaryExpr(internal::scalar_mod_op<Scalar>(rhs));
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseBinaryOp<internal::scalar_max_op<Scalar>, const Derived, const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived> >
    cwiseMax(Scalar threshold) const {
      return cwiseMax(constant(threshold));
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseBinaryOp<internal::scalar_min_op<Scalar>, const Derived, const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived> >
    cwiseMin(Scalar threshold) const {
      return cwiseMin(constant(threshold));
    }

    template <typename NewType> STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorConversionOp<NewType, const Derived>
    cast() const {
      return TensorConversionOp<NewType, const Derived>(derived());
    }

    // Generic binary operation support.
    template <typename CustomBinaryOp, typename OtherDerived> STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseBinaryOp<CustomBinaryOp, const Derived, const OtherDerived>
    ...
    template<typename OtherDerived> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseBinaryOp<internal::scalar_cmp_op<Scalar, internal::cmp_LT>, const Derived, const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived> >
    operator<(Scalar threshold) const {
      return operator<(constant(threshold));
    }
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseBinaryOp<internal::scalar_cmp_op<Scalar, internal::cmp_LE>, const Derived, const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived> >
    operator<=(Scalar threshold) const {
      return operator<=(constant(threshold));
    }
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseBinaryOp<internal::scalar_cmp_op<Scalar, internal::cmp_GT>, const Derived, const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived> >
    operator>(Scalar threshold) const {
      return operator>(constant(threshold));
    }
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseBinaryOp<internal::scalar_cmp_op<Scalar, internal::cmp_GE>, const Derived, const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived> >
    operator>=(Scalar threshold) const {
      return operator>=(constant(threshold));
    }
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseBinaryOp<internal::scalar_cmp_op<Scalar, internal::cmp_EQ>, const Derived, const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived> >
    operator==(Scalar threshold) const {
      return operator==(constant(threshold));
    }
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const TensorCwiseBinaryOp<internal::scalar_cmp_op<Scalar, internal::cmp_NEQ>, const Derived, const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived> >
    operator!=(Scalar threshold) const {
      return operator!=(constant(threshold));
    }

    // Coefficient-wise ternary operators.
    template<typename ThenDerived, typename ElseDerived> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    template<typename OtherDerived, typename Dimensions> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    // Convolutions.
    template<typename KernelDerived, typename Dimensions> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    // Fourier transforms
    template <int FFTDataType, int FFTDirection, typename FFT> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    // Reductions.
    template <typename Dims> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
   ...
   STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    template <typename Reducer, typename Dims> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    template <typename Broadcast> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    template <typename Axis, typename OtherDerived> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    template <typename PatchDims> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    template <typename NewDimensions> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    const TensorReshapingOp<const NewDimensions, const Derived>
    reshape(const NewDimensions& newDimensions) const {
      return TensorReshapingOp<const NewDimensions, const Derived>(derived(), newDimensions);
    }
    template <typename StartIndices, typename Sizes> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    const TensorSlicingOp<const StartIndices, const Sizes, const Derived>
    slice(const StartIndices& startIndices, const Sizes& sizes) const {
      return TensorSlicingOp<const StartIndices, const Sizes, const Derived>(derived(), startIndices, sizes);
    }
    template <Index DimId> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    template <typename ReverseDimensions> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    template <typename PaddingDimensions> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    ...
    template <typename Shuffle> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    const TensorShufflingOp<const Shuffle, const Derived>
    shuffle(const Shuffle& shuffle) const {
      return TensorShufflingOp<const Shuffle, const Derived>(derived(), shuffle);
    }
    template <typename Strides> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
  ...
  protected:
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const Derived& derived() const { return *static_cast<const Derived*>(this); }
};
...
class TensorBase<Derived, WriteAccessors> : public TensorBase<Derived, ReadOnlyAccessors> {
 public:
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Derived& setZero() {
      return setConstant(Scalar(0));
    }
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Derived& setConstant(const Scalar& val) {
      return derived() = this->constant(val);
    }
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Derived& setRandom() {
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Derived& setValues(
    ...
    template <DenseIndex DimId> STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE
    const TensorChippingOp<DimId, const Derived>
    chip(const Index offset) const {
      return TensorChippingOp<DimId, const Derived>(derived(), offset, DimId);
    }
 ...
 protected:
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Derived& derived() { return *static_cast<Derived*>(this); }
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE const Derived& derived() const { return *static_cast<const Derived*>(this); }
};
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_BASE_H
