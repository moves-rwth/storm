...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_DEVICE_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_DEVICE_H
...
template <typename ExpressionType, typename DeviceType> class TensorDevice {
  public:
    ...
    STORMEIGEN_STRONG_INLINE TensorDevice& operator=(const OtherDerived& other) {
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_DEVICE_H
