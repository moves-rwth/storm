...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_PATCH_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_PATCH_H
...
class TensorPatchOp : public TensorBase<TensorPatchOp<PatchDim, XprType>, ReadOnlyAccessors>
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorPatchOp(const XprType& expr, const PatchDim& patch_dims)
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_PATCH_H
