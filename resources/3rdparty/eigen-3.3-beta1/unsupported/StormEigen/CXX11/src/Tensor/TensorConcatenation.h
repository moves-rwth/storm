...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_CONCATENATION_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_CONCATENATION_H
...
template<typename Axis, typename LhsXprType, typename RhsXprType>
struct eval<TensorConcatenationOp<Axis, LhsXprType, RhsXprType>, StormEigen::Dense>
{
...
class TensorConcatenationOp : public TensorBase<TensorConcatenationOp<Axis, LhsXprType, RhsXprType>, WriteAccessors>
{
  public:
    ...
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorConcatenationOp(const LhsXprType& lhs, const RhsXprType& rhs, Axis axis)
    ...
    STORMEIGEN_DEVICE_FUNC const Axis& axis() const { return m_axis; }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE TensorConcatenationOp& operator = (const TensorConcatenationOp& other)
    {
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE TensorConcatenationOp& operator = (const OtherDerived& other)
    {
...
struct TensorEvaluator<const TensorConcatenationOp<Axis, LeftArgType, RightArgType>, Device>
{
  ...
  {
    STORMEIGEN_STATIC_ASSERT((static_cast<int>(TensorEvaluator<LeftArgType, Device>::Layout) == static_cast<int>(TensorEvaluator<RightArgType, Device>::Layout) || NumDims == 1), YOU_MADE_A_PROGRAMMING_MISTAKE);
    STORMEIGEN_STATIC_ASSERT(NumDims == RightNumDims, YOU_MADE_A_PROGRAMMING_MISTAKE);
  ...
  : public TensorEvaluator<const TensorConcatenationOp<Axis, LeftArgType, RightArgType>, Device>
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorEvaluator(XprType& op, const Device& device)
    : Base(op, device)
  {
    STORMEIGEN_STATIC_ASSERT((static_cast<int>(Layout) == static_cast<int>(ColMajor)), YOU_MADE_A_PROGRAMMING_MISTAKE);
  }
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_CONCATENATION_H
