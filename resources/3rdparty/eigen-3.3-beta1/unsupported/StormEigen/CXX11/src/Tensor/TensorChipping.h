...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_CHIPPING_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_CHIPPING_H
...
struct DimensionId
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE DenseIndex actualDim() const {
    return DimId;
  }
};
template <>
...
class TensorChippingOp : public TensorBase<TensorChippingOp<DimId, XprType> >
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorChippingOp(const XprType& expr, const Index offset, const Index dim)
  ...
  STORMEIGEN_DEVICE_FUNC
  STORMEIGEN_STRONG_INLINE TensorChippingOp& operator = (const TensorChippingOp& other)
  {
  ...
  STORMEIGEN_DEVICE_FUNC
  STORMEIGEN_STRONG_INLINE TensorChippingOp& operator = (const OtherDerived& other)
  {
...
struct TensorEvaluator<const TensorChippingOp<DimId, ArgType>, Device>
{
      ...
      : m_impl(op.expression(), device), m_dim(op.dim()), m_device(device)
  {
    ...
    STORMEIGEN_STATIC_ASSERT(NumInputDims >= 2, YOU_MADE_A_PROGRAMMING_MISTAKE);
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE Scalar* data() const {
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_CHIPPING_H
