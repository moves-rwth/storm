...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_DIMENSION_LIST_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_DIMENSION_LIST_H
...
template <typename Index, std::size_t Rank> struct DimensionList {
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE
...
#if defined(STORMEIGEN_HAS_CONSTEXPR)
template <typename Index, std::size_t Rank>
struct index_known_statically_impl<DimensionList<Index, Rank> > {
  STORMEIGEN_DEVICE_FUNC static constexpr bool run(const DenseIndex) {
    return true;
  }
};
template <typename Index, std::size_t Rank>
...
struct all_indices_known_statically_impl<DimensionList<Index, Rank> > {
  STORMEIGEN_DEVICE_FUNC static constexpr bool run() {
    return true;
  }
};
template <typename Index, std::size_t Rank>
...
template <typename Index, std::size_t Rank>
struct index_known_statically_impl<DimensionList<Index, Rank> > {
  STORMEIGEN_DEVICE_FUNC static STORMEIGEN_ALWAYS_INLINE bool run(const DenseIndex) {
    return true;
  }
};
template <typename Index, std::size_t Rank>
...
template <typename Index, std::size_t Rank>
struct all_indices_known_statically_impl<DimensionList<Index, Rank> > {
  STORMEIGEN_DEVICE_FUNC static STORMEIGEN_ALWAYS_INLINE bool run() {
    return true;
  }
};
template <typename Index, std::size_t Rank>
...
template <typename Index, std::size_t Rank>
struct indices_statically_known_to_increase_impl<DimensionList<Index, Rank> > {
  static STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE bool run() {
    return true;
  }
};
template <typename Index, std::size_t Rank>
...
template <typename Index, std::size_t Rank>
struct index_statically_eq_impl<DimensionList<Index, Rank> > {
  static STORMEIGEN_DEVICE_FUNC STORMEIGEN_ALWAYS_INLINE bool run(const DenseIndex, const DenseIndex) {
    return false;
  }
};
template <typename Index, std::size_t Rank>
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_DIMENSION_LIST_H
