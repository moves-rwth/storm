...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_LAYOUT_SWAP_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_LAYOUT_SWAP_H
...
class TensorLayoutSwapOp : public TensorBase<TensorLayoutSwapOp<XprType>, WriteAccessors>
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorLayoutSwapOp(const XprType& expr)
      : m_xpr(expr) {}
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE TensorLayoutSwapOp& operator = (const TensorLayoutSwapOp& other)
    {
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE TensorLayoutSwapOp& operator = (const OtherDerived& other)
    {
...
struct TensorEvaluator<const TensorLayoutSwapOp<ArgType>, Device>
{
  ...
  STORMEIGEN_DEVICE_FUNC Scalar* data() const { return m_impl.data(); }
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_LAYOUT_SWAP_H
