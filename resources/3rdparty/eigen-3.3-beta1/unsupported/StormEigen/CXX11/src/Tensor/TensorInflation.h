...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_INFLATION_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_INFLATION_H
...
class TensorInflationOp : public TensorBase<TensorInflationOp<Strides, XprType>, ReadOnlyAccessors>
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorInflationOp(const XprType& expr, const Strides& strides)
...
struct TensorEvaluator<const TensorInflationOp<Strides, ArgType>, Device>
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE bool getInputIndex(Index index, Index* inputIndex) const
  {
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_INFLATION_H
