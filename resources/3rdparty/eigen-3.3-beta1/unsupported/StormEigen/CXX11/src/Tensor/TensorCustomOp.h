...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_CUSTOM_OP_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_CUSTOM_OP_H
...
template<typename CustomUnaryFunc, typename XprType>
struct eval<TensorCustomUnaryOp<CustomUnaryFunc, XprType>, StormEigen::Dense>
{
...
class TensorCustomUnaryOp : public TensorBase<TensorCustomUnaryOp<CustomUnaryFunc, XprType>, ReadOnlyAccessors>
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorCustomUnaryOp(const XprType& expr, const CustomUnaryFunc& func)
...
struct TensorEvaluator<const TensorCustomUnaryOp<CustomUnaryFunc, XprType>, Device>
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorEvaluator(const ArgType& op, const Device& device)
  ...
  STORMEIGEN_DEVICE_FUNC CoeffReturnType* data() const { return m_result; }

 protected:
  STORMEIGEN_DEVICE_FUNC void evalTo(Scalar* data) {
...
template<typename CustomBinaryFunc, typename LhsXprType, typename RhsXprType>
struct eval<TensorCustomBinaryOp<CustomBinaryFunc, LhsXprType, RhsXprType>, StormEigen::Dense>
{
...
class TensorCustomBinaryOp : public TensorBase<TensorCustomBinaryOp<CustomBinaryFunc, LhsXprType, RhsXprType>, ReadOnlyAccessors>
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorCustomBinaryOp(const LhsXprType& lhs, const RhsXprType& rhs, const CustomBinaryFunc& func)
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_CUSTOM_OP_H
