...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_CONTRACTION_CUDA_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_CONTRACTION_CUDA_H
...
__device__ STORMEIGEN_STRONG_INLINE void
...
struct TensorEvaluator<const TensorContractionOp<Indices, LeftArgType, RightArgType>, GpuDevice> :
  ...
  STORMEIGEN_STRONG_INLINE bool evalSubExprsIfNeeded(Scalar* data) {
...
#endif // STORMEIGEN_USE_GPU and __CUDACC__
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_CONTRACTION_CUDA_H
