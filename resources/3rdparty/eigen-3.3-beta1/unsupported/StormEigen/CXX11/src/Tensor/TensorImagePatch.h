...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_IMAGE_PATCH_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_IMAGE_PATCH_H
...
class TensorImagePatchOp : public TensorBase<TensorImagePatchOp<Rows, Cols, XprType>, ReadOnlyAccessors>
{
  ...
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE TensorImagePatchOp(const XprType& expr, DenseIndex patch_rows, DenseIndex patch_cols,
...
struct TensorEvaluator<const TensorImagePatchOp<Rows, Cols, ArgType>, Device>
{
  ...
  {
    STORMEIGEN_STATIC_ASSERT(NumDims >= 4, YOU_MADE_A_PROGRAMMING_MISTAKE);
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_IMAGE_PATCH_H
