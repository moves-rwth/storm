...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_H
...
/** \class Tensor
  ...
  *
  * \code
  * StormEigen::Tensor<double, 4> t(10, 10, 10, 10);
  * t(0, 1, 2, 3) = 42.0;
  * \endcode
  *
  * This class can be extended with the help of the plugin mechanism described on the page
  * \ref TopicCustomizingEigen by defining the preprocessor symbol \c STORMEIGEN_TENSOR_PLUGIN.
  *
  * <i><b>Some notes:</b></i>
  *
  * <dl>
...
class Tensor : public TensorBase<Tensor<Scalar_, NumIndices_, Options_, IndexType_> >
{
  public:
    ...
    enum {
      IsAligned = bool(STORMEIGEN_MAX_ALIGN_BYTES>0) & !(Options_&DontAlign),
  ...
  public:
    ...
    STORMEIGEN_DEVICE_FUNC inline const Scalar& coeff(Index firstIndex, Index secondIndex, IndexTypes... otherIndices) const
    {
      // The number of indices used to access a tensor coefficient must be equal to the rank of the tensor.
      STORMEIGEN_STATIC_ASSERT(sizeof...(otherIndices) + 2 == NumIndices, YOU_MADE_A_PROGRAMMING_MISTAKE)
      return coeff(array<Index, NumIndices>{{firstIndex, secondIndex, otherIndices...}});
    }
#endif

    // normal indices
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE const Scalar& coeff(const array<Index, NumIndices>& indices) const
    {
...
#ifdef STORMEIGEN_HAS_SFINAE
    template<typename CustomIndices,
             STORMEIGEN_SFINAE_ENABLE_IF( !(isOfNormalIndex<CustomIndices>::value) )
    >
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE const Scalar& coeff(CustomIndices& indices) const
    {
        return coeff(internal::customIndices2Array<Index,NumIndices>(indices));
    }
#endif

    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE const Scalar& coeff() const
    {
      STORMEIGEN_STATIC_ASSERT(NumIndices == 0, YOU_MADE_A_PROGRAMMING_MISTAKE);
      return m_storage.data()[0];
    }

    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE const Scalar& coeff(Index index) const
    {
    ...
    // normal indices
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE Scalar& coeffRef(const array<Index, NumIndices>& indices)
    {
      eigen_internal_assert(checkIndexRange(indices));
      return m_storage.data()[linearizedIndex(indices)];
    }
    ...
    template<typename CustomIndices,
             STORMEIGEN_SFINAE_ENABLE_IF( !(isOfNormalIndex<CustomIndices>::value) )
             >
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE Scalar& coeffRef(CustomIndices& indices)
    {
        return coeffRef(internal::customIndices2Array<Index,NumIndices>(indices));
    }
#endif

    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE Scalar& coeffRef()
    {
      STORMEIGEN_STATIC_ASSERT(NumIndices == 0, YOU_MADE_A_PROGRAMMING_MISTAKE);
      return m_storage.data()[0];
    }
    ...
    template<typename CustomIndices,
             STORMEIGEN_SFINAE_ENABLE_IF( !(isOfNormalIndex<CustomIndices>::value) )
    >
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE const Scalar& operator()(CustomIndices& indices) const
    {
        return coeff(internal::customIndices2Array<Index,NumIndices>(indices));
    }
#endif
    ...
    // normal indices
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE const Scalar& operator()(const array<Index, NumIndices>& indices) const
    {
      return coeff(indices);
    }

    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE const Scalar& operator()(Index index) const
    {
      eigen_internal_assert(index >= 0 && index < size());
      return coeff(index);
    }

    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE const Scalar& operator()() const
    {
      STORMEIGEN_STATIC_ASSERT(NumIndices == 0, YOU_MADE_A_PROGRAMMING_MISTAKE);
      return coeff();
    }
    ...
    // normal indices
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE Scalar& operator()(const array<Index, NumIndices>& indices)
    {
    ...
    template<typename CustomIndices,
             STORMEIGEN_SFINAE_ENABLE_IF( !(isOfNormalIndex<CustomIndices>::value) )
    >
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE Scalar& operator()(CustomIndices& indices)
    {
      return coeffRef(internal::customIndices2Array<Index,NumIndices>(indices));
    }
#endif

    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE Scalar& operator()(Index index)
    {
      eigen_assert(index >= 0 && index < size());
      return coeffRef(index);
    }

    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE Scalar& operator()()
    {
      STORMEIGEN_STATIC_ASSERT(NumIndices == 0, YOU_MADE_A_PROGRAMMING_MISTAKE);
      return coeffRef();
    }
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Tensor()
      : m_storage()
    {
    }

    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Tensor(const Self& other)
...
#ifdef STORMEIGEN_HAS_VARIADIC_TEMPLATES
    template<typename... IndexTypes>
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE Tensor(Index firstDimension, IndexTypes... otherDimensions)
        : m_storage(internal::array_prod(array<Index, NumIndices>{{firstDimension, otherDimensions...}}), array<Index, NumIndices>{{firstDimension, otherDimensions...}})
    {
      ...
      STORMEIGEN_STATIC_ASSERT(sizeof...(otherDimensions) + 1 == NumIndices, YOU_MADE_A_PROGRAMMING_MISTAKE)
    }
#else
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE explicit Tensor(Index dim1)
      : m_storage(dim1, array<Index, 1>(dim1))
    {
      STORMEIGEN_STATIC_ASSERT(1 == NumIndices, YOU_MADE_A_PROGRAMMING_MISTAKE)
    }
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE explicit Tensor(Index dim1, Index dim2)
      : m_storage(dim1*dim2, array<Index, 2>(dim1, dim2))
    {
      STORMEIGEN_STATIC_ASSERT(2 == NumIndices, YOU_MADE_A_PROGRAMMING_MISTAKE)
    }
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE explicit Tensor(Index dim1, Index dim2, Index dim3)
      : m_storage(dim1*dim2*dim3, array<Index, 3>(dim1, dim2, dim3))
    {
      STORMEIGEN_STATIC_ASSERT(3 == NumIndices, YOU_MADE_A_PROGRAMMING_MISTAKE)
    }
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE explicit Tensor(Index dim1, Index dim2, Index dim3, Index dim4)
      : m_storage(dim1*dim2*dim3*dim4, array<Index, 4>(dim1, dim2, dim3, dim4))
    {
      STORMEIGEN_STATIC_ASSERT(4 == NumIndices, YOU_MADE_A_PROGRAMMING_MISTAKE)
    }
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE explicit Tensor(Index dim1, Index dim2, Index dim3, Index dim4, Index dim5)
      : m_storage(dim1*dim2*dim3*dim4*dim5, array<Index, 5>(dim1, dim2, dim3, dim4, dim5))
    {
      STORMEIGEN_STATIC_ASSERT(5 == NumIndices, YOU_MADE_A_PROGRAMMING_MISTAKE)
    }
#endif

    /** Normal Dimension */
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE explicit Tensor(const array<Index, NumIndices>& dimensions)
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Tensor(const TensorBase<OtherDerived, ReadOnlyAccessors>& other)
    {
    ...
    template<typename OtherDerived>
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Tensor(const TensorBase<OtherDerived, WriteAccessors>& other)
    {
      typedef TensorAssignOp<Tensor, const OtherDerived> Assign;
      Assign assign(*this, other.derived());
      resize(TensorEvaluator<const Assign, DefaultDevice>(assign, DefaultDevice()).dimensions());
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Tensor& operator=(const Tensor& other)
    {
    ...
    template<typename OtherDerived>
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE Tensor& operator=(const OtherDerived& other)
    {
      typedef TensorAssignOp<Tensor, const OtherDerived> Assign;
      Assign assign(*this, other);
      resize(TensorEvaluator<const Assign, DefaultDevice>(assign, DefaultDevice()).dimensions());
    ...
    /** Normal Dimension */
    STORMEIGEN_DEVICE_FUNC void resize(const array<Index, NumIndices>& dimensions)
    {
      int i;
      Index size = Index(1);
    ...
    STORMEIGEN_DEVICE_FUNC void resize(const DSizes<Index, NumIndices>& dimensions) {
    ...
    template<typename CustomDimension,
             STORMEIGEN_SFINAE_ENABLE_IF( !(isOfNormalIndex<CustomDimension>::value) )
    >
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE void resize(CustomDimension& dimensions)
    {
      resize(internal::customIndices2Array<Index,NumIndices>(dimensions));
    }
#endif

#ifndef STORMEIGEN_EMULATE_CXX11_META_H
  ...
  protected:
    ...
    STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE Index linearizedIndex(const array<Index, NumIndices>& indices) const
    {
      if (Options&RowMajor) {
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_H
