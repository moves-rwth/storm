...
#ifndef STORMEIGEN_CXX11_TENSOR_TENSOR_FORWARD_DECLARATIONS_H
#define STORMEIGEN_CXX11_TENSOR_TENSOR_FORWARD_DECLARATIONS_H
...
#endif // STORMEIGEN_CXX11_TENSOR_TENSOR_FORWARD_DECLARATIONS_H
