...
#ifndef STORMEIGEN_CXX11_TENSORSYMMETRY_SYMMETRY_H
#define STORMEIGEN_CXX11_TENSORSYMMETRY_SYMMETRY_H
...
class tensor_symmetry_value_setter
{
  ...
  private:
    ...
    {
      #ifdef STORMEIGEN_TENSOR_SYMMETRY_CHECK_VALUES
...
#endif // STORMEIGEN_CXX11_TENSORSYMMETRY_SYMMETRY_H
