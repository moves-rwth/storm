...
#ifndef STORMEIGEN_CXX11_TENSORSYMMETRY_STATICSYMMETRY_H
#define STORMEIGEN_CXX11_TENSORSYMMETRY_STATICSYMMETRY_H
...
template<STORMEIGEN_TPL_PP_SPEC_HACK_DEF(typename, empty)>
struct tensor_static_symgroup_do_apply<internal::type_list<STORMEIGEN_TPL_PP_SPEC_HACK_USE(empty)>>
{
  template<typename Op, typename RV, std::size_t SGNumIndices, typename Index, std::size_t NumIndices, typename... Args>
...
#endif // STORMEIGEN_CXX11_TENSORSYMMETRY_STATICSYMMETRY_H
