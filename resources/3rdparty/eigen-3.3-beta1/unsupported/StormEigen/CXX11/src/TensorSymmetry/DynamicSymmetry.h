...
#ifndef STORMEIGEN_CXX11_TENSORSYMMETRY_DYNAMICSYMMETRY_H
#define STORMEIGEN_CXX11_TENSORSYMMETRY_DYNAMICSYMMETRY_H
...
#endif // STORMEIGEN_CXX11_TENSORSYMMETRY_DYNAMICSYMMETRY_H
