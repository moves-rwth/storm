...
#ifndef STORMEIGEN_CXX11WORKAROUNDS_H
#define STORMEIGEN_CXX11WORKAROUNDS_H
...
#define STORMEIGEN_TPL_PP_SPEC_HACK_DEF(mt, n)    mt... n
#define STORMEIGEN_TPL_PP_SPEC_HACK_DEFC(mt, n)   , STORMEIGEN_TPL_PP_SPEC_HACK_DEF(mt, n)
#define STORMEIGEN_TPL_PP_SPEC_HACK_USE(n)        n...
#define STORMEIGEN_TPL_PP_SPEC_HACK_USEC(n)       , n...
#else
#define STORMEIGEN_TPL_PP_SPEC_HACK_DEF(mt, n)
#define STORMEIGEN_TPL_PP_SPEC_HACK_DEFC(mt, n)
#define STORMEIGEN_TPL_PP_SPEC_HACK_USE(n)
#define STORMEIGEN_TPL_PP_SPEC_HACK_USEC(n)
#endif
...
#endif // STORMEIGEN_CXX11WORKAROUNDS_H
