...
#ifndef STORMEIGEN_POLYNOMIAL_SOLVER_H
#define STORMEIGEN_POLYNOMIAL_SOLVER_H
...
#define STORMEIGEN_POLYNOMIAL_SOLVER_BASE_INHERITED_TYPES( BASE )  \
...
class PolynomialSolver : public PolynomialSolverBase<_Scalar,_Deg>
{
  public:
    ...
    STORMEIGEN_POLYNOMIAL_SOLVER_BASE_INHERITED_TYPES( PS_Base )
...
#endif // STORMEIGEN_POLYNOMIAL_SOLVER_H
