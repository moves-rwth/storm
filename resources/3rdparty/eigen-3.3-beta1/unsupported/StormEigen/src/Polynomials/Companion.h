...
#ifndef STORMEIGEN_COMPANION_H
#define STORMEIGEN_COMPANION_H

// This file requires the user to include
// * StormEigen/Core
// * StormEigen/src/PolynomialSolver.h
...
{
  public:
    STORMEIGEN_MAKE_ALIGNED_OPERATOR_NEW_IF_VECTORIZABLE_FIXED_SIZE(_Scalar,_Deg==Dynamic ? Dynamic : _Deg)
  ...
  public:
    STORMEIGEN_STRONG_INLINE const _Scalar operator()(Index row, Index col ) const
    {
...
{
  using std::abs;
  STORMEIGEN_STATIC_ASSERT( Deg == Dynamic || 1 < Deg, YOU_MADE_A_PROGRAMMING_MISTAKE );
  const Index deg   = m_monic.size();
  const Index deg_1 = deg-1;
