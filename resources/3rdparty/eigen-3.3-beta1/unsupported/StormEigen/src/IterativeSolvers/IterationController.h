...
#include "../../../../StormEigen/src/Core/util/NonMPL2.h"

#ifndef STORMEIGEN_ITERATION_CONTROLLER_H
#define STORMEIGEN_ITERATION_CONTROLLER_H
...
#endif // STORMEIGEN_ITERATION_CONTROLLER_H
