...
#ifndef STORMEIGEN_SKYLINEMATRIXBASE_H
#define STORMEIGEN_SKYLINEMATRIXBASE_H
...
public:
     ...
     */
    STORMEIGEN_STRONG_INLINE const typename internal::eval<Derived, IsSkyline>::type eval() const {
...
#endif // STORMEIGEN_SkylineMatrixBase_H
