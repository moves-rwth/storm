...
#ifndef STORMEIGEN_SKYLINEPRODUCT_H
#define STORMEIGEN_SKYLINEPRODUCT_H
...
struct internal::traits<SkylineProduct<LhsNested, RhsNested, ProductMode> > {
    ...
    enum {
        ...
        InnerSize = STORMEIGEN_SIZE_MIN_PREFER_FIXED(_LhsNested::ColsAtCompileTime, _RhsNested::RowsAtCompileTime),
...
public:
    ...
    STORMEIGEN_GENERIC_PUBLIC_INTERFACE(SkylineProduct)
...
public:
    ...
    STORMEIGEN_STRONG_INLINE SkylineProduct(const Lhs& lhs, const Rhs& rhs)
    : m_lhs(lhs), m_rhs(rhs) {
        ...
        enum {
            ...
            SameSizes = STORMEIGEN_PREDICATE_SAME_MATRIX_SIZE(_LhsNested, _RhsNested)
        };
    ...
    STORMEIGEN_STRONG_INLINE Index rows() const {
        return m_lhs.rows();
    }

    STORMEIGEN_STRONG_INLINE Index cols() const {
        return m_rhs.cols();
    }

    STORMEIGEN_STRONG_INLINE const _LhsNested& lhs() const {
        return m_lhs;
    }

    STORMEIGEN_STRONG_INLINE const _RhsNested& rhs() const {
        return m_rhs;
    }
...
STORMEIGEN_DONT_INLINE void skyline_row_major_time_dense_product(const Lhs& lhs, const Rhs& rhs, Dest& dst) {
...
template<typename Lhs, typename Rhs, typename Dest>
STORMEIGEN_DONT_INLINE void skyline_col_major_time_dense_product(const Lhs& lhs, const Rhs& rhs, Dest& dst) {
    typedef typename remove_all<Lhs>::type _Lhs;
    typedef typename remove_all<Rhs>::type _Rhs;
    typedef typename traits<Lhs>::Scalar Scalar;
...
STORMEIGEN_STRONG_INLINE const typename SkylineProductReturnType<Derived, OtherDerived>::Type
...
#endif // STORMEIGEN_SKYLINEPRODUCT_H
