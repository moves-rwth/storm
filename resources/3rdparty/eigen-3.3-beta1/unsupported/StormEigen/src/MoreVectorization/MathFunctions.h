...
#ifndef STORMEIGEN_MOREVECTORIZATION_MATHFUNCTIONS_H
#define STORMEIGEN_MOREVECTORIZATION_MATHFUNCTIONS_H
...
#ifdef STORMEIGEN_VECTORIZE_SSE

template<> STORMEIGEN_DONT_INLINE Packet4f pasin(Packet4f x)
{
  _STORMEIGEN_DECLARE_CONST_Packet4f(half, 0.5);
  _STORMEIGEN_DECLARE_CONST_Packet4f(minus_half, -0.5);
  _STORMEIGEN_DECLARE_CONST_Packet4f(3half, 1.5);

  _STORMEIGEN_DECLARE_CONST_Packet4f_FROM_INT(sign_mask, 0x80000000);

  _STORMEIGEN_DECLARE_CONST_Packet4f(pi, 3.141592654);
  _STORMEIGEN_DECLARE_CONST_Packet4f(pi_over_2, 3.141592654*0.5);

  _STORMEIGEN_DECLARE_CONST_Packet4f(asin1, 4.2163199048E-2);
  _STORMEIGEN_DECLARE_CONST_Packet4f(asin2, 2.4181311049E-2);
  _STORMEIGEN_DECLARE_CONST_Packet4f(asin3, 4.5470025998E-2);
  _STORMEIGEN_DECLARE_CONST_Packet4f(asin4, 7.4953002686E-2);
  _STORMEIGEN_DECLARE_CONST_Packet4f(asin5, 1.6666752422E-1);
...
#endif // STORMEIGEN_VECTORIZE_SSE

} // end namespace internal

} // end namespace StormEigen

#endif // STORMEIGEN_MOREVECTORIZATION_MATHFUNCTIONS_H
