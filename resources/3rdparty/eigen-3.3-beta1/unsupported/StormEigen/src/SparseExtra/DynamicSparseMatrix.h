...
#ifndef STORMEIGEN_DYNAMIC_SPARSEMATRIX_H
#define STORMEIGEN_DYNAMIC_SPARSEMATRIX_H
  ...
  : public SparseMatrixBase<DynamicSparseMatrix<_Scalar, _Options, _StorageIndex> >
{
  ...
  public:
    STORMEIGEN_SPARSE_PUBLIC_INTERFACE(DynamicSparseMatrix)
    // FIXME: why are these operator already alvailable ???
    // STORMEIGEN_SPARSE_INHERIT_ASSIGNMENT_OPERATOR(DynamicSparseMatrix, +=)
    // STORMEIGEN_SPARSE_INHERIT_ASSIGNMENT_OPERATOR(DynamicSparseMatrix, -=)
...
#   ifdef STORMEIGEN_DYNAMICSPARSEMATRIX_PLUGIN
#     include STORMEIGEN_DYNAMICSPARSEMATRIX_PLUGIN
#   endif
 };
...
#endif // STORMEIGEN_DYNAMIC_SPARSEMATRIX_H
