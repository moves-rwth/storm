...
#ifndef STORMEIGEN_SPARSEBLOCKMATRIX_H
#define STORMEIGEN_SPARSEBLOCKMATRIX_H
...
{
  public:
    STORMEIGEN_PRODUCT_PUBLIC_INTERFACE(BlockSparseTimeDenseProduct)
...
class BlockSparseMatrix : public SparseMatrixBase<BlockSparseMatrix<_Scalar,_BlockAtCompileTime, _Options,_StorageIndex> >
{
  ...
  public:
    ...
    {
      STORMEIGEN_STATIC_ASSERT((m_blockSize != Dynamic), THIS_METHOD_IS_ONLY_FOR_FIXED_SIZE);
...
#endif // STORMEIGEN_SPARSEBLOCKMATRIX_H
