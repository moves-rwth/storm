...
#ifndef STORMEIGEN_RANDOMSETTER_H
#define STORMEIGEN_RANDOMSETTER_H
...
/** Represents a std::unordered_map
  *
  * To use it you need to both define STORMEIGEN_UNORDERED_MAP_SUPPORT and include the unordered_map header file
...
#endif // STORMEIGEN_UNORDERED_MAP_SUPPORT
...
/** \class RandomSetter
  ...
  *  - \#include <google/dense_hash_map> yourself \b before StormEigen/Sparse header
...
#endif // STORMEIGEN_RANDOMSETTER_H
