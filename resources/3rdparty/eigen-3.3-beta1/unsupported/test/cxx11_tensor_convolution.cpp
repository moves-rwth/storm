...
static void test_evals()
{
  ...
  result.setZero();
  StormEigen::array<Tensor<float, 2>::Index, 1> dims3{{0}};
...
static void test_expr()
{
  ...
  StormEigen::array<ptrdiff_t, 2> dims;
  dims[0] = 0;
  dims[1] = 1;
...
static void test_modes() {
  ...
  StormEigen::array<ptrdiff_t, 1> dims;
  dims[0] = 0;
  StormEigen::array<std::pair<ptrdiff_t, ptrdiff_t>, 1> padding;
...
static void test_strides() {
  ...
  StormEigen::array<ptrdiff_t, 1> dims;
  dims[0] = 0;
  StormEigen::array<ptrdiff_t, 1> stride_of_3;
  stride_of_3[0] = 3;
  StormEigen::array<ptrdiff_t, 1> stride_of_2;
  stride_of_2[0] = 2;
