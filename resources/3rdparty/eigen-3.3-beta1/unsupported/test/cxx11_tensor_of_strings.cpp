...
static void test_slices()
{
  ...
  const StormEigen::DSizes<ptrdiff_t, 2> half_size(2, 3);
  const StormEigen::DSizes<ptrdiff_t, 2> first_half(0, 0);
  const StormEigen::DSizes<ptrdiff_t, 2> second_half(0, 3);
