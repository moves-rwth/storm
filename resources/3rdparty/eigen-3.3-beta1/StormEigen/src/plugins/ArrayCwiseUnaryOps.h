...
STORMEIGEN_STRONG_INLINE const AbsReturnType
abs() const
{
...
/** \returns an expression of the coefficient-wise phase angle of \c *this
  ...
  */
STORMEIGEN_DEVICE_FUNC
STORMEIGEN_STRONG_INLINE const ArgReturnType
arg() const
{
...
/** \returns an expression of the coefficient-wise squared absolute value of \c *this
  ...
  */
STORMEIGEN_DEVICE_FUNC
STORMEIGEN_STRONG_INLINE const Abs2ReturnType
abs2() const
{
...
operator!() const
{
  STORMEIGEN_STATIC_ASSERT((internal::is_same<bool,Scalar>::value),
