...
#ifndef STORMEIGEN_BDCSVD_H
#define STORMEIGEN_BDCSVD_H
// #define STORMEIGEN_BDCSVD_DEBUG_VERBOSE
// #define STORMEIGEN_BDCSVD_SANITY_CHECKS
namespace StormEigen {

#ifdef STORMEIGEN_BDCSVD_DEBUG_VERBOSE
...
public:
  ...
  enum {
    ...
    DiagSizeAtCompileTime = STORMEIGEN_SIZE_MIN_PREFER_DYNAMIC(RowsAtCompileTime, ColsAtCompileTime), 
    MaxRowsAtCompileTime = MatrixType::MaxRowsAtCompileTime, 
    MaxColsAtCompileTime = MatrixType::MaxColsAtCompileTime, 
    MaxDiagSizeAtCompileTime = STORMEIGEN_SIZE_MIN_PREFER_FIXED(MaxRowsAtCompileTime, MaxColsAtCompileTime), 
...
#ifdef STORMEIGEN_BDCSVD_SANITY_CHECKS
...
#if defined STORMEIGEN_INTERNAL_DEBUGGING || defined STORMEIGEN_BDCSVD_DEBUG_VERBOSE
