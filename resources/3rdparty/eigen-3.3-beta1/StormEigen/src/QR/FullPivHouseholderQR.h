...
#ifndef STORMEIGEN_FULLPIVOTINGHOUSEHOLDERQR_H
#define STORMEIGEN_FULLPIVOTINGHOUSEHOLDERQR_H
...
template<typename _MatrixType> class FullPivHouseholderQR
{
  public:
    ...
    typedef Matrix<StorageIndex, 1,
                   STORMEIGEN_SIZE_MIN_PREFER_DYNAMIC(ColsAtCompileTime,RowsAtCompileTime), RowMajor, 1,
                   STORMEIGEN_SIZE_MIN_PREFER_FIXED(MaxColsAtCompileTime,MaxRowsAtCompileTime)> IntDiagSizeVectorType;
...
#endif // STORMEIGEN_FULLPIVOTINGHOUSEHOLDERQR_H
