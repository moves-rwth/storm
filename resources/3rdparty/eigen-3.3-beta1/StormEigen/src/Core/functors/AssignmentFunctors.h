...
#ifndef STORMEIGEN_ASSIGNMENT_FUNCTORS_H
#define STORMEIGEN_ASSIGNMENT_FUNCTORS_H
...
template<typename Scalar> struct assign_op {
  ...
  STORMEIGEN_EMPTY_STRUCT_CTOR(assign_op)
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE void assignCoeff(Scalar& a, const Scalar& b) const { a = b; }
  
  template<int Alignment, typename Packet>
  STORMEIGEN_STRONG_INLINE void assignPacket(Scalar* a, const Packet& b) const
...
template<typename Scalar> struct add_assign_op {
  ...
  STORMEIGEN_EMPTY_STRUCT_CTOR(add_assign_op)
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE void assignCoeff(Scalar& a, const Scalar& b) const { a += b; }
...
template<typename Scalar> struct sub_assign_op {
  ...
  STORMEIGEN_EMPTY_STRUCT_CTOR(sub_assign_op)
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE void assignCoeff(Scalar& a, const Scalar& b) const { a -= b; }
...
struct mul_assign_op {
  ...
  STORMEIGEN_EMPTY_STRUCT_CTOR(mul_assign_op)
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE void assignCoeff(DstScalar& a, const SrcScalar& b) const { a *= b; }
  
  template<int Alignment, typename Packet>
  STORMEIGEN_STRONG_INLINE void assignPacket(DstScalar* a, const Packet& b) const
...
template<typename Scalar> struct div_assign_op {
  ...
  STORMEIGEN_EMPTY_STRUCT_CTOR(div_assign_op)
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE void assignCoeff(Scalar& a, const Scalar& b) const { a /= b; }
...
template<typename Scalar> struct swap_assign_op {
  ...
  STORMEIGEN_EMPTY_STRUCT_CTOR(swap_assign_op)
  STORMEIGEN_DEVICE_FUNC STORMEIGEN_STRONG_INLINE void assignCoeff(Scalar& a, const Scalar& b) const
  {
#ifdef __CUDACC__
...
#endif // STORMEIGEN_ASSIGNMENT_FUNCTORS_H
