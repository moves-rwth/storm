...
#ifndef STORMEIGEN_SOLVE_H
#define STORMEIGEN_SOLVE_H
...
public:
  ...
  STORMEIGEN_DEVICE_FUNC Index rows() const { return m_dec.cols(); }
  STORMEIGEN_DEVICE_FUNC Index cols() const { return m_rhs.cols(); }

  STORMEIGEN_DEVICE_FUNC const Decomposition& dec() const { return m_dec; }
  STORMEIGEN_DEVICE_FUNC const RhsType&       rhs() const { return m_rhs; }
  ...
  : public evaluator<typename Solve<Decomposition,RhsType>::PlainObject>
{
  ...
  STORMEIGEN_DEVICE_FUNC explicit evaluator(const SolveType& solve)
