...
#ifndef STORMEIGEN_TRIANGULARMATRIX_H
#define STORMEIGEN_TRIANGULARMATRIX_H
...
template<typename Derived> class TriangularBase : public EigenBase<Derived>
{
  public:
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE void copyCoeff(Index row, Index col, Other& other)
    {
  ...
  protected:
    ...
    {
      STORMEIGEN_ONLY_USED_FOR_DEBUG(row);
      STORMEIGEN_ONLY_USED_FOR_DEBUG(col);
      eigen_assert(col>=0 && col<cols() && row>=0 && row<rows());
      const int mode = int(Mode) & ~SelfAdjoint;
      STORMEIGEN_ONLY_USED_FOR_DEBUG(mode);
  ...
  : public TriangularViewImpl<_MatrixType, _Mode, typename internal::traits<_MatrixType>::StorageKind >
{
  ...
  public:
    ...
    {
      STORMEIGEN_STATIC_ASSERT_LVALUE(MatrixType)
  ...
  // workaround MSVC ICE
    ...
    {
      STORMEIGEN_STATIC_ASSERT((Mode&(UnitDiag|ZeroDiag))==0,PROGRAMMING_ERROR);
  ...
  : public TriangularBase<TriangularView<_MatrixType, _Mode> >
{
  ...
  public:
    ...
    {
      STORMEIGEN_STATIC_ASSERT_LVALUE(TriangularViewType);
      Base::check_coordinates_internal(row, col);
...
#endif
    {
      STORMEIGEN_STATIC_ASSERT_LVALUE(OtherDerived);
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE void _solve_impl(const RhsType &rhs, DstType &dst) const {
    ...
    STORMEIGEN_DEVICE_FUNC
    STORMEIGEN_STRONG_INLINE TriangularViewType& _assignProduct(const ProductType& prod, const Scalar& alpha);
};
...
public:
  ...
  STORMEIGEN_DEVICE_FUNC triangular_dense_assignment_kernel(DstEvaluatorType &dst, const SrcEvaluatorType &src, const Functor &func, DstXprType& dstExpr)
    : Base(dst, src, func, dstExpr)
  {}
  
#ifdef STORMEIGEN_INTERNAL_DEBUGGING
  STORMEIGEN_DEVICE_FUNC void assignCoeff(Index row, Index col)
  {
  ...
  STORMEIGEN_DEVICE_FUNC void assignDiagonalCoeff(Index id)
  {
  ...
  STORMEIGEN_DEVICE_FUNC void assignOppositeCoeff(Index row, Index col)
  { 
    eigen_internal_assert(row!=col);
    if(SetOpposite)
...
STORMEIGEN_DEVICE_FUNC void call_triangular_assignment_loop(const DstXprType& dst, const SrcXprType& src, const Functor &func)
{
  ...
  enum {
      unroll = DstXprType::SizeAtCompileTime != Dynamic
            ...
            && DstXprType::SizeAtCompileTime * SrcEvaluatorType::CoeffReadCost / 2 <= STORMEIGEN_UNROLLING_LIMIT
    };
...
STORMEIGEN_DEVICE_FUNC void call_triangular_assignment_loop(const DstXprType& dst, const SrcXprType& src)
{
...
#endif // STORMEIGEN_TRIANGULARMATRIX_H
