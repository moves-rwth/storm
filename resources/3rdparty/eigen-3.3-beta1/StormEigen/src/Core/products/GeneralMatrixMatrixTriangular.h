...
#ifndef STORMEIGEN_GENERAL_MATRIX_MATRIX_TRIANGULAR_H
#define STORMEIGEN_GENERAL_MATRIX_MATRIX_TRIANGULAR_H
...
struct general_matrix_matrix_triangular_product<Index,LhsScalar,LhsStorageOrder,ConjugateLhs,RhsScalar,RhsStorageOrder,ConjugateRhs,RowMajor,UpLo,Version>
{
  ...
  static STORMEIGEN_STRONG_INLINE void run(Index size, Index depth,const LhsScalar* lhs, Index lhsStride,
...
{
  typedef typename scalar_product_traits<LhsScalar, RhsScalar>::ReturnType ResScalar;
  static STORMEIGEN_STRONG_INLINE void run(Index size, Index depth,const LhsScalar* _lhs, Index lhsStride,
...
struct tribb_kernel
{
  ...
  enum {
    BlockSize  = STORMEIGEN_PLAIN_ENUM_MAX(mr,nr)
  };
...
#endif // STORMEIGEN_GENERAL_MATRIX_MATRIX_TRIANGULAR_H
