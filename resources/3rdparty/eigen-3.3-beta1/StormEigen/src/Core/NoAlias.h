...
#ifndef STORMEIGEN_NOALIAS_H
#define STORMEIGEN_NOALIAS_H
...
class NoAlias
{
  public:
    ...
    STORMEIGEN_STRONG_INLINE ExpressionType& operator=(const StorageBase<OtherDerived>& other)
    {
