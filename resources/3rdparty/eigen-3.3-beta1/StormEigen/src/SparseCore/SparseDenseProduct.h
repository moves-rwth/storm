...
#ifndef STORMEIGEN_SPARSEDENSEPRODUCT_H
#define STORMEIGEN_SPARSEDENSEPRODUCT_H
...
public:
  ...
  public:
    ...
    STORMEIGEN_STRONG_INLINE Index outer() const { return m_outer; }
    STORMEIGEN_STRONG_INLINE Index row()   const { return NeedToTranspose ? m_outer : LhsIterator::index(); }
    STORMEIGEN_STRONG_INLINE Index col()   const { return NeedToTranspose ? LhsIterator::index() : m_outer; }

    STORMEIGEN_STRONG_INLINE Scalar value() const { return LhsIterator::value() * m_factor; }
    STORMEIGEN_STRONG_INLINE operator bool() const { return LhsIterator::operator bool() && (!m_empty); }
...
#endif // STORMEIGEN_SPARSEDENSEPRODUCT_H
