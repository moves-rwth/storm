...
#ifndef STORMEIGEN_SPARSE_REF_H
#define STORMEIGEN_SPARSE_REF_H
...
public:
  ...
  STORMEIGEN_SPARSE_PUBLIC_INTERFACE(SparseRefBase)
  ...
  : public internal::SparseRefBase<Ref<SparseMatrix<MatScalar,MatOptions,MatIndex>, Options, StrideType > >
{
  ...
  public:
    ...
    STORMEIGEN_SPARSE_PUBLIC_INTERFACE(Ref)
    ...
    {
      STORMEIGEN_STATIC_ASSERT(bool(Traits::template match<SparseMatrix<MatScalar,OtherOptions,MatIndex> >::MatchAtCompileTime), STORAGE_LAYOUT_DOES_NOT_MATCH);
  ...
  : public internal::SparseRefBase<Ref<SparseVector<MatScalar,MatOptions,MatIndex>, Options, StrideType > >
{
  ...
  public:
    ...
    {
      STORMEIGEN_STATIC_ASSERT(bool(Traits::template match<SparseVector<MatScalar,OtherOptions,MatIndex> >::MatchAtCompileTime), STORAGE_LAYOUT_DOES_NOT_MATCH);
      Base::construct(expr.derived());
    }
