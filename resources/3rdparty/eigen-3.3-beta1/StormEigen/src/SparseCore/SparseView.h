...
#ifndef STORMEIGEN_SPARSEVIEW_H
#define STORMEIGEN_SPARSEVIEW_H
...
public:
  STORMEIGEN_SPARSE_PUBLIC_INTERFACE(SparseView)
  ...
  public:
    ...
    class InnerIterator : public EvalIterator
    {
      ...
      public:
        ...
        STORMEIGEN_STRONG_INLINE InnerIterator(const unary_evaluator& sve, Index outer)
  ...
  public:
    ...
    class InnerIterator
    {
      public:
        ...
        STORMEIGEN_STRONG_INLINE StorageIndex index() const { return m_inner; }
