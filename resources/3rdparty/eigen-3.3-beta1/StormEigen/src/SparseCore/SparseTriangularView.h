...
#ifndef STORMEIGEN_SPARSE_TRIANGULARVIEW_H
#define STORMEIGEN_SPARSE_TRIANGULARVIEW_H
  ...
  : public SparseMatrixBase<TriangularView<MatrixType,Mode> >
{
  ...
  public:
    ...
    STORMEIGEN_SPARSE_PUBLIC_INTERFACE(TriangularViewType)
...
class TriangularViewImpl<MatrixType,Mode,Sparse>::InnerIterator : public MatrixTypeNestedCleaned::InnerIterator
{
  ...
  public:
    ...
    STORMEIGEN_STRONG_INLINE InnerIterator(const TriangularViewImpl& view, Index outer)
    ...
    STORMEIGEN_STRONG_INLINE operator bool() const
    {
      if(HasUnitDiag && m_returnOne)
        return true;
...
class TriangularViewImpl<MatrixType,Mode,Sparse>::ReverseInnerIterator : public MatrixTypeNestedCleaned::ReverseInnerIterator
{
  ...
  public:
    ...
    STORMEIGEN_STRONG_INLINE ReverseInnerIterator(const TriangularViewType& view, Index outer)
...
public:
  ...
  class InnerIterator : public EvalIterator
  {
    ...
    public:
      ...
      STORMEIGEN_STRONG_INLINE InnerIterator(const unary_evaluator& xprEval, Index outer)
...
#endif // STORMEIGEN_SPARSE_TRIANGULARVIEW_H
