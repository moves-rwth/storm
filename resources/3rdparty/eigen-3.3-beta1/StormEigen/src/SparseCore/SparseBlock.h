...
#ifndef STORMEIGEN_SPARSE_BLOCK_H
#define STORMEIGEN_SPARSE_BLOCK_H
...
public:
    STORMEIGEN_SPARSE_PUBLIC_INTERFACE(BlockType)
    ...
    STORMEIGEN_STRONG_INLINE Index rows() const { return IsRowMajor ? m_outerSize.value() : m_matrix.rows(); }
    STORMEIGEN_STRONG_INLINE Index cols() const { return IsRowMajor ? m_matrix.cols() : m_outerSize.value(); }
...
public:
    ...
    {
      STORMEIGEN_STATIC_ASSERT_VECTOR_ONLY(sparse_matrix_block_impl);
...
public:
  ...
  STORMEIGEN_STRONG_INLINE InnerVectorInnerIterator(const unary_evaluator& aEval, Index outer)
...
public:
  ...
  STORMEIGEN_STRONG_INLINE OuterVectorInnerIterator(const unary_evaluator& aEval, Index outer)
    : m_eval(aEval),
...
#endif // STORMEIGEN_SPARSE_BLOCK_H
