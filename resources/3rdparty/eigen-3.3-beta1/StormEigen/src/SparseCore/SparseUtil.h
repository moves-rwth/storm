...
#ifndef STORMEIGEN_SPARSEUTIL_H
#define STORMEIGEN_SPARSEUTIL_H

namespace StormEigen { 

#ifdef NDEBUG
#define STORMEIGEN_DBG_SPARSE(X)
#else
#define STORMEIGEN_DBG_SPARSE(X) X
#endif

#define STORMEIGEN_SPARSE_INHERIT_ASSIGNMENT_OPERATOR(Derived, Op) \
template<typename OtherDerived> \
STORMEIGEN_STRONG_INLINE Derived& operator Op(const StormEigen::SparseMatrixBase<OtherDerived>& other) \
{ \
...
#define STORMEIGEN_SPARSE_INHERIT_SCALAR_ASSIGNMENT_OPERATOR(Derived, Op) \
...
#define STORMEIGEN_SPARSE_INHERIT_ASSIGNMENT_OPERATORS(Derived) \
STORMEIGEN_SPARSE_INHERIT_ASSIGNMENT_OPERATOR(Derived, =)


#define STORMEIGEN_SPARSE_PUBLIC_INTERFACE(Derived) \
...
template<typename Lhs, typename Rhs,
         int InnerSize = STORMEIGEN_SIZE_MIN_PREFER_FIXED(internal::traits<Lhs>::ColsAtCompileTime,internal::traits<Rhs>::RowsAtCompileTime)> struct DenseSparseProductReturnType;
         
template<typename Lhs, typename Rhs,
         int InnerSize = STORMEIGEN_SIZE_MIN_PREFER_FIXED(internal::traits<Lhs>::ColsAtCompileTime,internal::traits<Rhs>::RowsAtCompileTime)> struct SparseDenseProductReturnType;
