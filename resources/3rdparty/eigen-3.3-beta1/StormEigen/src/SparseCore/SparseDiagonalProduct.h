...
#ifndef STORMEIGEN_SPARSE_DIAGONAL_PRODUCT_H
#define STORMEIGEN_SPARSE_DIAGONAL_PRODUCT_H
...
public:
  ...
  public:
    ...
    STORMEIGEN_STRONG_INLINE Scalar value() const { return m_coeff * SparseXprInnerIterator::value(); }
  protected:
...
struct sparse_diagonal_product_evaluator<SparseXprType, DiagCoeffType, SDP_AsCwiseProduct>
{
  ...
  public:
    ...
    STORMEIGEN_STRONG_INLINE InnerIterator& operator++() { ++m_sparseIter; return *this; }
...
#endif // STORMEIGEN_SPARSE_DIAGONAL_PRODUCT_H
