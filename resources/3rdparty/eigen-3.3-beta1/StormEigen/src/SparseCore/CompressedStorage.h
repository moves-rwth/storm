...
#ifndef STORMEIGEN_COMPRESSED_STORAGE_H
#define STORMEIGEN_COMPRESSED_STORAGE_H
...
class CompressedStorage
{
  ...
  protected:
    ...
    {
      #ifdef STORMEIGEN_SPARSE_COMPRESSED_STORAGE_REALLOCATE_PLUGIN
        STORMEIGEN_SPARSE_COMPRESSED_STORAGE_REALLOCATE_PLUGIN
      #endif
...
#endif // STORMEIGEN_COMPRESSED_STORAGE_H
