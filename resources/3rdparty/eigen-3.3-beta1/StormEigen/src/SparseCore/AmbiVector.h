...
#ifndef STORMEIGEN_AMBIVECTOR_H
#define STORMEIGEN_AMBIVECTOR_H
...
_Scalar& AmbiVector<_Scalar,_StorageIndex>::coeffRef(Index i)
{
  ...
  {
    ListEl* STORMEIGEN_RESTRICT llElements = reinterpret_cast<ListEl*>(m_buffer);
...
class AmbiVector<_Scalar,_StorageIndex>::Iterator
{
  public:
      ...
      : m_vector(vec)
    {
      ...
      {
        ListEl* STORMEIGEN_RESTRICT llElements = reinterpret_cast<ListEl*>(m_vector.m_buffer);
