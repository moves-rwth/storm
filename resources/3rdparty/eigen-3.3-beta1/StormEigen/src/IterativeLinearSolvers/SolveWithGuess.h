...
#ifndef STORMEIGEN_SOLVEWITHGUESS_H
#define STORMEIGEN_SOLVEWITHGUESS_H
...
public:
  ...
  STORMEIGEN_DEVICE_FUNC const GuessType&     guess() const { return m_guess; }
...
#endif // STORMEIGEN_SOLVEWITHGUESS_H
