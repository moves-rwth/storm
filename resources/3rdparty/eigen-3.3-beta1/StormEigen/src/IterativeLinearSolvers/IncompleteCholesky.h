...
#ifndef STORMEIGEN_INCOMPLETE_CHOlESKY_H
#define STORMEIGEN_INCOMPLETE_CHOlESKY_H
...
/** 
  ...
  *                       unless STORMEIGEN_MPL2_ONLY is defined, in which case the default is NaturalOrdering<int>.
  *
