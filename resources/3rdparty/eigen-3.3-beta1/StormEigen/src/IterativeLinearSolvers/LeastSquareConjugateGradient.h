...
#ifndef STORMEIGEN_LEAST_SQUARE_CONJUGATE_GRADIENT_H
#define STORMEIGEN_LEAST_SQUARE_CONJUGATE_GRADIENT_H
...
#endif // STORMEIGEN_LEAST_SQUARE_CONJUGATE_GRADIENT_H
