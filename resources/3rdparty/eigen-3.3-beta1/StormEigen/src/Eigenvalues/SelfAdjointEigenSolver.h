...
#ifndef STORMEIGEN_SELFADJOINTSTORMEIGENSOLVER_H
#define STORMEIGEN_SELFADJOINTSTORMEIGENSOLVER_H
...
template<typename SolverType> struct direct_selfadjoint_eigenvalues<SolverType,3,false>
{
  ...
  static inline void computeRoots(const MatrixType& m, VectorType& roots)
  {
    ...
    STORMEIGEN_USING_STD_MATH(atan2)
    STORMEIGEN_USING_STD_MATH(cos)
    STORMEIGEN_USING_STD_MATH(sin)
  ...
  static inline void run(SolverType& solver, const MatrixType& mat, int options)
  {
    ...
    if(computeEigenvectors)
    {
      if((eivals(2)-eivals(0))<=StormEigen::NumTraits<Scalar>::epsilon())
      {
      ...
      else
      {
        ...
        if(d0<=2*StormEigen::NumTraits<Scalar>::epsilon()*d1)
        {
...
struct direct_selfadjoint_eigenvalues<SolverType,2,false>
{
  ...
  static inline void run(SolverType& solver, const MatrixType& mat, int options)
  {
    ...
    if(computeEigenvectors)
    {
      if((eivals(1)-eivals(0))<=abs(eivals(1))*StormEigen::NumTraits<Scalar>::epsilon())
      {
        eivecs.setIdentity();
      }
      else
...
#endif // STORMEIGEN_SELFADJOINTSTORMEIGENSOLVER_H
