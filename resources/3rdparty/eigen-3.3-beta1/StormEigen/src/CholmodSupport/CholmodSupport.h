...
#ifndef STORMEIGEN_CHOLMODSUPPORT_H
#define STORMEIGEN_CHOLMODSUPPORT_H
...
{
  STORMEIGEN_STATIC_ASSERT((internal::traits<Derived>::Flags&RowMajorBit)==0,THIS_METHOD_IS_ONLY_FOR_COLUMN_MAJOR_MATRICES);
...
#endif // STORMEIGEN_CHOLMODSUPPORT_H
