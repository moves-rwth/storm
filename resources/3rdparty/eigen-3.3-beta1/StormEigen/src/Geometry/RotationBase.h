...
#ifndef STORMEIGEN_ROTATIONBASE_H
#define STORMEIGEN_ROTATIONBASE_H
...
class RotationBase
{
  ...
  public:
    ...
    STORMEIGEN_STRONG_INLINE typename internal::rotation_base_generic_product_selector<Derived,OtherDerived,OtherDerived::IsVectorAtCompileTime>::ReturnType
...
struct rotation_base_generic_product_selector<RotationDerived,OtherVectorType,true>
{
  ...
  static STORMEIGEN_STRONG_INLINE ReturnType run(const RotationDerived& r, const OtherVectorType& v)
  {
...
{
  STORMEIGEN_STATIC_ASSERT_MATRIX_SPECIFIC_SIZE(Matrix,int(OtherDerived::Dim),int(OtherDerived::Dim))
...
{
  STORMEIGEN_STATIC_ASSERT(OtherDerived::RowsAtCompileTime==Dim && OtherDerived::ColsAtCompileTime==Dim,
...
#endif // STORMEIGEN_ROTATIONBASE_H
