...
#ifndef STORMEIGEN_ORTHOMETHODS_H
#define STORMEIGEN_ORTHOMETHODS_H
...
{
  STORMEIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(Derived,3)
  STORMEIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(OtherDerived,3)
...
{
  STORMEIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(Derived,4)
  STORMEIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(OtherDerived,4)
...
#endif // STORMEIGEN_ORTHOMETHODS_H
