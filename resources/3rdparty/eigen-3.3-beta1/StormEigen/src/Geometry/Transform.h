...
#ifndef STORMEIGEN_TRANSFORM_H
#define STORMEIGEN_TRANSFORM_H
...
/** \geometry_module \ingroup Geometry_Module
  ...
  * preprocessor token STORMEIGEN_QT_SUPPORT is defined.
  *
  * This class can be extended with the help of the plugin mechanism described on the page
  * \ref TopicCustomizingEigen by defining the preprocessor symbol \c STORMEIGEN_TRANSFORM_PLUGIN.
  *
...
{
public:
  STORMEIGEN_MAKE_ALIGNED_OPERATOR_NEW_IF_VECTORIZABLE_FIXED_SIZE(_Scalar,_Dim==Dynamic ? Dynamic : (_Dim+1)*(_Dim+1))
  enum {
    Mode = _Mode,
    Options = _Options,
...
public:
  ...
  inline Transform(const Transform<Scalar,Dim,OtherMode,OtherOptions>& other)
  {
    ...
    STORMEIGEN_STATIC_ASSERT(STORMEIGEN_IMPLIES(OtherMode==int(Projective), Mode==int(Projective)),
                        YOU_PERFORMED_AN_INVALID_TRANSFORMATION_CONVERSION)

    // prevent conversions as:
    // Isometry = Affine | AffineCompact
    STORMEIGEN_STATIC_ASSERT(STORMEIGEN_IMPLIES(OtherMode==int(Affine)||OtherMode==int(AffineCompact), Mode!=int(Isometry)),
                        YOU_PERFORMED_AN_INVALID_TRANSFORMATION_CONVERSION)
  ...
  template<typename OtherDerived>
  STORMEIGEN_STRONG_INLINE const typename OtherDerived::PlainObject
...
public:
  ...
  #ifdef STORMEIGEN_TRANSFORM_PLUGIN
  #include STORMEIGEN_TRANSFORM_PLUGIN
  #endif
  
protected:
  #ifndef STORMEIGEN_PARSED_BY_DOXYGEN
    static STORMEIGEN_STRONG_INLINE void check_template_params()
    {
      STORMEIGEN_STATIC_ASSERT((Options & (DontAlign|RowMajor)) == Options, INVALID_MATRIX_TEMPLATE_PARAMETERS)
    }
  #endif
...
/** Initializes \c *this from a QMatrix assuming the dimension is 2.
  *
  * This function is available only if the token STORMEIGEN_QT_SUPPORT is defined.
  */
...
{
  STORMEIGEN_STATIC_ASSERT(Dim==2, YOU_MADE_A_PROGRAMMING_MISTAKE)
  if (Mode == int(AffineCompact))
...
{
  STORMEIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(OtherDerived,int(Dim))
  STORMEIGEN_STATIC_ASSERT(Mode!=int(Isometry), THIS_METHOD_IS_ONLY_FOR_SPECIFIC_TRANSFORMATIONS)
...
{
  STORMEIGEN_STATIC_ASSERT(int(Dim)==2, YOU_MADE_A_PROGRAMMING_MISTAKE)
  STORMEIGEN_STATIC_ASSERT(Mode!=int(Isometry), THIS_METHOD_IS_ONLY_FOR_SPECIFIC_TRANSFORMATIONS)
...
struct transform_right_product_impl< TransformType, MatrixType, 0 >
{
  ...
  static STORMEIGEN_STRONG_INLINE ResultType run(const TransformType& T, const MatrixType& other)
  {
...
struct transform_right_product_impl< TransformType, MatrixType, 1 >
{
  ...
  static STORMEIGEN_STRONG_INLINE ResultType run(const TransformType& T, const MatrixType& other)
  {
    STORMEIGEN_STATIC_ASSERT(OtherRows==HDim, YOU_MIXED_MATRICES_OF_DIFFERENT_SIZES);
...
struct transform_right_product_impl< TransformType, MatrixType, 2 >
{
  ...
  static STORMEIGEN_STRONG_INLINE ResultType run(const TransformType& T, const MatrixType& other)
  {
    STORMEIGEN_STATIC_ASSERT(OtherRows==Dim, YOU_MIXED_MATRICES_OF_DIFFERENT_SIZES);
