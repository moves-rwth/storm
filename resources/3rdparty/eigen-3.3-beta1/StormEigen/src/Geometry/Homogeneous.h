...
#ifndef STORMEIGEN_HOMOGENEOUS_H
#define STORMEIGEN_HOMOGENEOUS_H
  ...
  : public MatrixBase<Homogeneous<MatrixType,_Direction> >, internal::no_assignment_operator
{
  public:
    ...
    STORMEIGEN_DENSE_PUBLIC_INTERFACE(Homogeneous)
    ...
    STORMEIGEN_STRONG_INLINE typename internal::result_of<Func(Scalar,Scalar)>::type
 ...
 : public evaluator<typename homogeneous_right_product_refactoring_helper<typename Lhs::NestedExpression,Rhs>::Xpr>
{
  ...
  STORMEIGEN_DEVICE_FUNC explicit product_evaluator(const XprType& xpr)
...
#endif // STORMEIGEN_HOMOGENEOUS_H
