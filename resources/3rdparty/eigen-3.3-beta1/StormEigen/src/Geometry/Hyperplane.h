...
#ifndef STORMEIGEN_HYPERPLANE_H
#define STORMEIGEN_HYPERPLANE_H
...
{
public:
  STORMEIGEN_MAKE_ALIGNED_OPERATOR_NEW_IF_VECTORIZABLE_FIXED_SIZE(_Scalar,_AmbientDim==Dynamic ? Dynamic : _AmbientDim+1)
  enum {
  ...
  {
    STORMEIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(VectorType, 3)
    Hyperplane result(p0.size());
  ...
  {
    using std::abs;
    STORMEIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(VectorType, 2)
