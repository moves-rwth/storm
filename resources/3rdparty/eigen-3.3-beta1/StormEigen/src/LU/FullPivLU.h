...
#ifndef STORMEIGEN_LU_H
#define STORMEIGEN_LU_H
  ...
  : public SolverBase<FullPivLU<_MatrixType> >
{
  public:
    ...
    STORMEIGEN_GENERIC_PUBLIC_INTERFACE(FullPivLU)
    // FIXME StorageIndex defined in STORMEIGEN_GENERIC_PUBLIC_INTERFACE should be int
    enum {
...
{
  STORMEIGEN_MAKE_KERNEL_HELPERS(FullPivLU<_MatrixType>)

  enum { MaxSmallDimAtCompileTime = STORMEIGEN_SIZE_MIN_PREFER_FIXED(
...
{
  STORMEIGEN_MAKE_IMAGE_HELPERS(FullPivLU<_MatrixType>)
