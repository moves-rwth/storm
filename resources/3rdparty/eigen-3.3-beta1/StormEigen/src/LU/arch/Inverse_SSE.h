...
#ifndef STORMEIGEN_INVERSE_SSE_H
#define STORMEIGEN_INVERSE_SSE_H
...
struct compute_inverse_size4<Architecture::SSE, float, MatrixType, ResultType>
{
  ...
  static void run(const MatrixType& mat, ResultType& result)
  {
    ...
    STORMEIGEN_ALIGN16 const unsigned int _Sign_PNNP[4] = { 0x00000000, 0x80000000, 0x80000000, 0x00000000 };
...
#endif // STORMEIGEN_INVERSE_SSE_H
