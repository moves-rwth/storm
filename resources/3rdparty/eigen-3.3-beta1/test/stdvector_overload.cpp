...
STORMEIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Vector4f)

STORMEIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Matrix2f)
STORMEIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Matrix4f)
STORMEIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Matrix4d)

STORMEIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Affine3f)
STORMEIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Affine3d)

STORMEIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Quaternionf)
STORMEIGEN_DEFINE_STL_VECTOR_SPECIALIZATION(Quaterniond)
